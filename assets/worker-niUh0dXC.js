...
Particles!`,L="#ffffff",k=["#ff0000","#00ff00","#0000ff"],F={fontFamily:"Arial",fontSize:64,italic:!1,weight:600,letterSpacing:0,lineHeight:1.2},U=`// This function will be called twice for each particle, because all particles reach the target in two frames.
...
};`}}))),E=(e,a)=>{const{width:r,height:o,data:c}=e,l=Math.ceil(r/a),s=Math.ceil(o/a),n=new Uint8Array(Math.ceil(r/a)*Math.ceil(o/a));let d=0;for(let h=0;h<o;h+=a)for(let u=0;u<r;u+=a){let g=!1;for(let m=0;m<a&&!g;m++)for(let p=0;p<a&&!g;p++){const M=u+p,I=h+m;if(M<r&&I<o){const lt=(I*r+M)*4;c[lt+3]>10&&(g=!0)}}n[d++]=g?1:0}return{validBlocks:n,blockWidth:l,blockHeight:s}},b=(e,a,i)=>e+i*(a-e),D=e=>{e=e.replace(/^#/,"");const a=parseInt(e,16),i=a>>16&255,r=a>>8&255,o=a&255;return{r:i,g:r,b:o}},K=(e,a,i)=>"#"+((1<<24)+(e<<16)+(a<<8)+i).toString(16).slice(1),_=(e,a)=>{if(!(e!=null&&e.length))return"#ffffff";if(e.length===1)return e[0];const r=Math.max(0,Math.min(1,a))*(e.length-1),o=Math.floor(r);if(o===e.length-1)return e[e.length-1];const c=r-o,l=D(e[o]),s=D(e[o+1]),n=Math.round(b(l.r,s.r,c)),d=Math.round(b(l.g,s.g,c)),h=Math.round(b(l.b,s.b,c));return K(n,d,h)},A=({dimensions:{width:e,height:a},emitterX:i=e/2,emitterY:r=a/2,emitterSize:o=100,emitterAngle:c=0})=>({top:()=>({x:Math.random()*e,y:0}),center:()=>({x:Math.round(e/2),y:Math.round(a/2)}),bottom:()=>({x:Math.random()*e,y:a}),random:()=>({x:Math.random()*e,y:Math.random()*a}),left:()=>({x:0,y:Math.random()*a}),right:()=>({x:e,y:Math.random()*a}),"top-left":()=>({x:Math.random()*(e/5),y:Math.random()*(a/5)}),"top-right":()=>({x:e,y:Math.random()*(a/5)}),"bottom-left":()=>({x:Math.random()*(e/5),y:a-Math.random()*(a/5)}),"bottom-right":()=>({x:e-Math.random()*(e/5),y:a-Math.random()*(a/5)}),canvasEdges:()=>{const s=Math.floor(Math.random()*4);return s===0?{x:Math.random()*e,y:0}:s===1?{x:Math.random()*e,y:a}:s===2?{x:0,y:Math.random()*a}:{x:e,y:Math.random()*a}},topLeft:()=>({x:0,y:0}),emitterPoint:()=>({x:i,y:r}),emitterCircle:()=>{const s=Math.random()*2*Math.PI,n=Math.random()*o;return{x:i+n*Math.cos(s),y:r+n*Math.sin(s)}},emitterSquare:()=>({x:i+(Math.random()-.5)*o,y:r+(Math.random()-.5)*o}),emitterHLine:()=>{const s=c*(Math.PI/180),n=(Math.random()-.5)*o;return{x:i+n*Math.cos(s),y:r+n*Math.sin(s)}},emitterVLine:()=>{const s=(c+90)*(Math.PI/180),n=(Math.random()-.5)*o;return{x:i+n*Math.cos(s),y:r+n*Math.sin(s)}},enterTopTextWidth:()=>({x:e*.2+Math.random()*e*.6,y:a*.3}),enterBottomTextWidth:()=>({x:e*.2+Math.random()*e*.6,y:a*.7}),enterLeftTextHeight:()=>({x:e*.2,y:a*.3+Math.random()*a*.4}),enterRightTextHeight:()=>({x:e*.8,y:a*.3+Math.random()*a*.4})});let S;const O={particleRadius:5,startPosition:X,selectedMovementFunction:y,movementFunctionCode:V()[y].code,text:w,font:F,particleColors:k,animationDuration:3e3,particleSpread:3,startParticleOpacity:1,endParticleOpacity:1,startParticleSize:5,endParticleSize:1,particleSizeEasing:Y,particleOpacityEasing:R,delay:0,emitterX:N,emitterY:q,emitterSize:H,emitterAngle:W},t={workerParticles:[],imageBitmap:null,animationFrameId:0,frameCanvas:null,frameContext:null,mainCanvas:null,mainContext:null,validBlocks:null,blockHeight:0,blockWidth:0,appProps:O,revealProgress:0};let P;const G=async e=>{t.mainCanvas=e,t.mainContext=t.mainCanvas.getContext("bitmaprenderer"),t.frameCanvas=new OffscreenCanvas(t.mainCanvas.width,t.mainCanvas.height),t.frameContext=t.frameCanvas.getContext("2d",{willReadFrequently:!0})},J=e=>{const{imageBitmap:a,canvas:i,dimensions:r,appProps:o}=e;t.imageBitmap=a,Object.keys(o).length&&(t.appProps={...O,...o}),G(i),t.frameContext.drawImage(t.imageBitmap,0,0);const{validBlocks:c,blockHeight:l,blockWidth:s}=E(t.frameContext.getImageData(0,0,t.mainCanvas.width,t.mainCanvas.height),t.appProps.particleRadius);t.validBlocks=c,t.blockHeight=l,t.blockWidth=s,P=A({dimensions:r,emitterX:t.appProps.emitterX,emitterY:t.appProps.emitterY,emitterSize:t.appProps.emitterSize,emitterAngle:t.appProps.emitterAngle}),t.workerParticles=C({validBlocks:t.validBlocks,radius:t.appProps.particleRadius,blockHeight:t.blockHeight,blockWidth:t.blockWidth,startPosition:t.appProps.startPosition,delay:t.appProps.delay,animationDuration:t.appProps.animationDuration}),self.postMessage({type:v.INITIALIZED,data:t.appProps})},C=({validBlocks:e,radius:a,blockHeight:i,blockWidth:r,startPosition:o,delay:c,animationDuration:l})=>{const s=[];for(let n=0;n<i;n++)for(let d=0;d<r;d++){const h=n*r+d;if(e[h]){const u=d*a,g=n*a,{x:m,y:p}=P[o](),M=Math.random()*c,I=l-M;s.push({targetX:u,targetY:g,x:m,y:p,initialX:m,initialY:p,scale:1,opacity:1,color:L,revealProgress:0,revealThreshold:.97+Math.random()*.02,reachedTarget:!1,emittedBubbles:!1,delay:M,lifetime:I})}}return s},tt=(e,a)=>{if(a>(e.revealThreshold||.99))return 1;if(a>.85&&Math.sqrt(Math.pow(e.x-e.targetX,2)+Math.pow(e.y-e.targetY,2))<=5){const o=(e.revealThreshold||.99)-.02,c=Math.max(0,(a-o)/.02);return Math.min(1,c)}return 0},et=e=>{const a=t.appProps.startParticleOpacity,i=t.appProps.endParticleOpacity,r=at(e,t.appProps.particleOpacityEasing);if(t.appProps.particleOpacityEasing!=="linear"){const o=Math.min(a,i),c=Math.max(a,i);return o+(c-o)*r}return a+(i-a)*r},at=(e,a)=>{switch(a){case"bell":return Math.sin(e*Math.PI);case"linear":return e;case"multiPulse":const r=e*5%1;return Math.sin(r*Math.PI);default:return 1}},it=(e,a)=>{switch(a){case"bell":return Math.sin(e*Math.PI);case"linear":return e;case"multiPulse":const r=e*5%1;return Math.sin(r*Math.PI);default:return 1}},nt=e=>{const a=t.appProps.startParticleSize,i=t.appProps.endParticleSize,r=it(e,t.appProps.particleSizeEasing);if(t.appProps.particleSizeEasing!=="linear"){const o=Math.min(a,i),c=Math.max(a,i);return o+(c-o)*r}return a+(i-a)*r},x=(e,a)=>{let i=!0;t.frameContext.clearRect(0,0,t.frameCanvas.width,t.frameCanvas.height);const r=a-e;t.revealProgress=Math.min(1,r/t.appProps.animationDuration),t.frameContext.globalAlpha=1,t.workerParticles.forEach(n=>{if(n.delay>a-e)return;const d=r-n.delay,h=Math.max(0,Math.min(1,d/n.lifetime));S(n,e,a,{width:t.mainCanvas.width,height:t.mainCanvas.height},t.appProps.animationDuration);const u=tt(n,t.revealProgress),g=et(h),m=nt(h);if(u>0&&u<1){const p=t.appProps.particleRadius*(m||1);t.frameContext.globalAlpha=g*(1-u),t.frameContext.beginPath(),t.frameContext.arc(Math.floor(n.x)+p/2,Math.floor(n.y)+p/2,p/2,0,2*Math.PI),t.frameContext.fillStyle=t.appProps.particleColors.length?_(t.appProps.particleColors,t.revealProgress):n.color,t.frameContext.fill(),t.frameContext.globalAlpha=u*g,t.frameContext.drawImage(t.imageBitmap,n.targetX,n.targetY,m,m,Math.floor(n.x),Math.floor(n.y),m,m)}else if(u>=1)t.frameContext.globalAlpha=1,t.frameContext.drawImage(t.imageBitmap,n.targetX,n.targetY,t.appProps.particleRadius,t.appProps.particleRadius,Math.floor(n.x),Math.floor(n.y),t.appProps.particleRadius,t.appProps.particleRadius);else{const p=t.appProps.particleRadius*(m||1);t.frameContext.globalAlpha=g,t.frameContext.beginPath(),t.frameContext.arc(Math.floor(n.x)+p/2,Math.floor(n.y)+p/2,p/2,0,2*Math.PI),t.frameContext.fillStyle=t.appProps.particleColors.length?_(t.appProps.particleColors,t.revealProgress):n.color,t.frameContext.fill()}(n.x!==n.targetX||n.y!==n.targetY||t.revealProgress<.99)&&(i=!1)});const o=t.frameCanvas.transferToImageBitmap();t.mainContext.transferFromImageBitmap(o);const c=i&&t.revealProgress>=1,l=t.appProps.animationDuration;c&&r>=l?t.animationFrameId&&(cancelAnimationFrame(t.animationFrameId),t.frameContext.drawImage(t.imageBitmap,0,0),self.postMessage({type:v.ANIMATION_COMPLETE})):t.animationFrameId=requestAnimationFrame(n=>x(e,n))},rt=()=>{t.animationFrameId&&cancelAnimationFrame(t.animationFrameId),S=new Function(t.appProps.movementFunctionCode)();const e=performance.now();t.revealProgress=0,x(e,e)},ot=()=>{t.animationFrameId&&cancelAnimationFrame(t.animationFrameId),t.workerParticles=t.workerParticles.map(a=>{const i=P[t.appProps.startPosition](),r=Math.random()*t.appProps.delay,o=t.appProps.animationDuration-r;return{x:i.x,y:i.y,initialX:i.x,initialY:i.y,targetX:a.targetX,targetY:a.targetY,scale:1,opacity:1,color:a.color,revealProgress:0,revealThreshold:a.revealThreshold,delay:r,lifetime:o}}),t.frameContext.clearRect(0,0,t.frameCanvas.width,t.frameCanvas.height);const e=t.frameCanvas.transferToImageBitmap();t.mainContext.transferFromImageBitmap(e),t.animationFrameId&&cancelAnimationFrame(t.animationFrameId)},st=e=>{if(t.imageBitmap=e,t.frameCanvas&&t.mainCanvas){t.frameCanvas.width=t.imageBitmap.width,t.frameCanvas.height=t.imageBitmap.height,t.mainCanvas.width=t.imageBitmap.width,t.mainCanvas.height=t.imageBitmap.height,t.frameContext.drawImage(t.imageBitmap,0,0);const{validBlocks:a,blockHeight:i,blockWidth:r}=E(t.frameContext.getImageData(0,0,t.mainCanvas.width,t.mainCanvas.height),t.appProps.particleRadius);t.validBlocks=a,t.blockHeight=i,t.blockWidth=r,P=A({dimensions:{width:t.mainCanvas.width,height:t.mainCanvas.height},emitterX:t.appProps.emitterX,emitterY:t.appProps.emitterY,emitterSize:t.appProps.emitterSize,emitterAngle:t.appProps.emitterAngle}),t.frameContext.clearRect(0,0,t.frameCanvas.width,t.frameCanvas.height);const o=t.frameCanvas.transferToImageBitmap();t.mainContext.transferFromImageBitmap(o),t.workerParticles=C({validBlocks:t.validBlocks,radius:t.appProps.particleRadius,blockHeight:t.blockHeight,blockWidth:t.blockWidth,startPosition:t.appProps.startPosition,delay:t.appProps.delay,animationDuration:t.appProps.animationDuration})}},ct=e=>{const{appProps:a,shouldUpdateStartCoordinatesConfig:i,shouldRegenerateImageBlocks:r}=e;if(Object.assign(t.appProps,a),r){t.frameContext.drawImage(t.imageBitmap,0,0);const{validBlocks:o,blockHeight:c,blockWidth:l}=E(t.frameContext.getImageData(0,0,t.mainCanvas.width,t.mainCanvas.height),t.appProps.particleRadius);t.validBlocks=o,t.blockHeight=c,t.blockWidth=l}if(i&&(P=A({dimensions:{width:t.mainCanvas.width,height:t.mainCanvas.height},emitterX:t.appProps.emitterX,emitterY:t.appProps.emitterY,emitterSize:t.appProps.emitterSize,emitterAngle:t.appProps.emitterAngle})),t.workerParticles=C({validBlocks:t.validBlocks??new Uint8Array,radius:t.appProps.particleRadius,blockHeight:t.blockHeight,blockWidth:t.blockWidth,startPosition:t.appProps.startPosition,delay:t.appProps.delay,animationDuration:t.appProps.animationDuration}),self.postMessage({type:v.UPDATE_APP_PROPS,data:t.appProps}),t.animationFrameId){cancelAnimationFrame(t.animationFrameId);const o=performance.now();x(o,o)}};self.onmessage=e=>{const{payload:a,type:i}=e.data;switch(i){case f.INITIALIZE:{J(a);break}case f.PLAY:{rt();break}case f.RESET:{ot();break}case f.UPDATE_APP_PROPS:{ct(a);break}case f.UPDATE_BITMAP:{st(a);break}}}})();
