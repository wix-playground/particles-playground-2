...
Particles!`,X="#ffffff",w=["#ff0000","#00ff00","#0000ff"],k={fontFamily:"Arial",fontSize:64,italic:!1,weight:600,letterSpacing:0,lineHeight:1.2},L=`// This function will be called twice for each particle, because all particles reach the target in two frames.
...
}`,z=()=>Object.assign({},{[y]:{code:`${T}${F}`},DEV_TWO_FRAMES:{code:`${T}${L}`},bezier:{code:`${T}${W}`},pulseColorCycle:{code:`${T}${$}`},timeDistortion:{code:`${T}${j}`},elasticPlop:{code:`${T}${Z}`}},...H.map(({name:e,comment:a,definition:i})=>({[e]:{code:`${T}return (particle, animationStartTime, currentTime, canvasDimensions, animationDuration) => {
...
};`}}))),b=(e,a)=>{const{width:n,height:o,data:c}=e,m=Math.ceil(n/a),s=Math.ceil(o/a),r=new Uint8Array(Math.ceil(n/a)*Math.ceil(o/a));let d=0;for(let h=0;h<o;h+=a)for(let u=0;u<n;u+=a){let g=!1;for(let p=0;p<a&&!g;p++)for(let l=0;l<a&&!g;l++){const v=u+l,M=h+p;if(v<n&&M<o){const nt=(M*n+v)*4;c[nt+3]>10&&(g=!0)}}r[d++]=g?1:0}return{validBlocks:r,blockWidth:m,blockHeight:s}},E=(e,a,i)=>e+i*(a-e),D=e=>{e=e.replace(/^#/,"");const a=parseInt(e,16),i=a>>16&255,n=a>>8&255,o=a&255;return{r:i,g:n,b:o}},Q=(e,a,i)=>"#"+((1<<24)+(e<<16)+(a<<8)+i).toString(16).slice(1),_=(e,a)=>{if(!(e!=null&&e.length))return"#ffffff";if(e.length===1)return e[0];const n=Math.max(0,Math.min(1,a))*(e.length-1),o=Math.floor(n);if(o===e.length-1)return e[e.length-1];const c=n-o,m=D(e[o]),s=D(e[o+1]),r=Math.round(E(m.r,s.r,c)),d=Math.round(E(m.g,s.g,c)),h=Math.round(E(m.b,s.b,c));return Q(r,d,h)},A=({dimensions:{width:e,height:a},emitterX:i=e/2,emitterY:n=a/2,emitterSize:o=100,emitterAngle:c=0})=>({top:()=>({x:Math.random()*e,y:0}),center:()=>({x:Math.round(e/2),y:Math.round(a/2)}),bottom:()=>({x:Math.random()*e,y:a}),random:()=>({x:Math.random()*e,y:Math.random()*a}),left:()=>({x:0,y:Math.random()*a}),right:()=>({x:e,y:Math.random()*a}),"top-left":()=>({x:Math.random()*(e/5),y:Math.random()*(a/5)}),"top-right":()=>({x:e,y:Math.random()*(a/5)}),"bottom-left":()=>({x:Math.random()*(e/5),y:a-Math.random()*(a/5)}),"bottom-right":()=>({x:e-Math.random()*(e/5),y:a-Math.random()*(a/5)}),canvasEdges:()=>{const s=Math.floor(Math.random()*4);return s===0?{x:Math.random()*e,y:0}:s===1?{x:Math.random()*e,y:a}:s===2?{x:0,y:Math.random()*a}:{x:e,y:Math.random()*a}},topLeft:()=>({x:0,y:0}),emitterPoint:()=>({x:i,y:n}),emitterCircle:()=>{const s=Math.random()*2*Math.PI,r=Math.random()*o;return{x:i+r*Math.cos(s),y:n+r*Math.sin(s)}},emitterSquare:()=>({x:i+(Math.random()-.5)*o,y:n+(Math.random()-.5)*o}),emitterHLine:()=>{const s=c*(Math.PI/180),r=(Math.random()-.5)*o;return{x:i+r*Math.cos(s),y:n+r*Math.sin(s)}},emitterVLine:()=>{const s=(c+90)*(Math.PI/180),r=(Math.random()-.5)*o;return{x:i+r*Math.cos(s),y:n+r*Math.sin(s)}},enterTopTextWidth:()=>({x:e*.2+Math.random()*e*.6,y:a*.3}),enterBottomTextWidth:()=>({x:e*.2+Math.random()*e*.6,y:a*.7}),enterLeftTextHeight:()=>({x:e*.2,y:a*.3+Math.random()*a*.4}),enterRightTextHeight:()=>({x:e*.8,y:a*.3+Math.random()*a*.4})});let S;const O={particleRadius:5,startPosition:Y,selectedMovementFunction:y,movementFunctionCode:z()[y].code,text:R,font:k,particleColors:w,animationDuration:3e3,particleSpread:3,startParticleOpacity:1,endParticleOpacity:1,startParticleSize:5,endParticleSize:1,delay:0,emitterX:U,emitterY:B,emitterSize:N,emitterAngle:q},t={workerParticles:[],imageBitmap:null,animationFrameId:0,frameCanvas:null,frameContext:null,mainCanvas:null,mainContext:null,validBlocks:null,blockHeight:0,blockWidth:0,appProps:O,revealProgress:0};let P;const V=async e=>{t.mainCanvas=e,t.mainContext=t.mainCanvas.getContext("bitmaprenderer"),t.frameCanvas=new OffscreenCanvas(t.mainCanvas.width,t.mainCanvas.height),t.frameContext=t.frameCanvas.getContext("2d",{willReadFrequently:!0})},K=e=>{const{imageBitmap:a,canvas:i,dimensions:n,appProps:o}=e;t.imageBitmap=a,Object.keys(o).length&&(t.appProps={...O,...o}),V(i),t.frameContext.drawImage(t.imageBitmap,0,0);const{validBlocks:c,blockHeight:m,blockWidth:s}=b(t.frameContext.getImageData(0,0,t.mainCanvas.width,t.mainCanvas.height),t.appProps.particleRadius);t.validBlocks=c,t.blockHeight=m,t.blockWidth=s,P=A({dimensions:n,emitterX:t.appProps.emitterX,emitterY:t.appProps.emitterY,emitterSize:t.appProps.emitterSize,emitterAngle:t.appProps.emitterAngle}),t.workerParticles=x({validBlocks:t.validBlocks,radius:t.appProps.particleRadius,blockHeight:t.blockHeight,blockWidth:t.blockWidth,startPosition:t.appProps.startPosition,delay:t.appProps.delay,animationDuration:t.appProps.animationDuration}),self.postMessage({type:I.INITIALIZED,data:t.appProps})},x=({validBlocks:e,radius:a,blockHeight:i,blockWidth:n,startPosition:o,delay:c,animationDuration:m})=>{const s=[];for(let r=0;r<i;r++)for(let d=0;d<n;d++){const h=r*n+d;if(e[h]){const u=d*a,g=r*a,{x:p,y:l}=P[o](),v=Math.random()*c,M=m-v;s.push({targetX:u,targetY:g,x:p,y:l,initialX:p,initialY:l,scale:1,opacity:1,color:X,revealProgress:0,revealThreshold:.97+Math.random()*.02,reachedTarget:!1,emittedBubbles:!1,delay:v,lifetime:M})}}return s},G=(e,a)=>{if(a>(e.revealThreshold||.99))return 1;if(a>.85&&Math.sqrt(Math.pow(e.x-e.targetX,2)+Math.pow(e.y-e.targetY,2))<=5){const o=(e.revealThreshold||.99)-.02,c=Math.max(0,(a-o)/.02);return Math.min(1,c)}return 0},J=e=>{const a=t.appProps.startParticleOpacity,i=t.appProps.endParticleOpacity;return a+(i-a)*e},tt=e=>{const a=t.appProps.startParticleSize,i=t.appProps.endParticleSize;return a+(i-a)*e},C=(e,a)=>{let i=!0;t.frameContext.clearRect(0,0,t.frameCanvas.width,t.frameCanvas.height);const n=a-e;t.revealProgress=Math.min(1,n/t.appProps.animationDuration),t.frameContext.globalAlpha=1,t.workerParticles.forEach(r=>{if(r.delay>a-e)return;const d=n-r.delay,h=Math.max(0,Math.min(1,d/r.lifetime));S(r,e,a,{width:t.mainCanvas.width,height:t.mainCanvas.height},t.appProps.animationDuration);const u=G(r,t.revealProgress),g=J(h),p=tt(h);if(u>0&&u<1){const l=t.appProps.particleRadius*(p||1);t.frameContext.globalAlpha=g*(1-u),t.frameContext.beginPath(),t.frameContext.arc(Math.floor(r.x)+l/2,Math.floor(r.y)+l/2,l/2,0,2*Math.PI),t.frameContext.fillStyle=t.appProps.particleColors.length?_(t.appProps.particleColors,t.revealProgress):r.color,t.frameContext.fill(),t.frameContext.globalAlpha=u*g,t.frameContext.drawImage(t.imageBitmap,r.targetX,r.targetY,p,p,Math.floor(r.x),Math.floor(r.y),p,p)}else if(u>=1)t.frameContext.globalAlpha=1,t.frameContext.drawImage(t.imageBitmap,r.targetX,r.targetY,t.appProps.particleRadius,t.appProps.particleRadius,Math.floor(r.x),Math.floor(r.y),t.appProps.particleRadius,t.appProps.particleRadius);else{const l=t.appProps.particleRadius*(p||1);t.frameContext.globalAlpha=g,t.frameContext.beginPath(),t.frameContext.arc(Math.floor(r.x)+l/2,Math.floor(r.y)+l/2,l/2,0,2*Math.PI),t.frameContext.fillStyle=t.appProps.particleColors.length?_(t.appProps.particleColors,t.revealProgress):r.color,t.frameContext.fill()}(r.x!==r.targetX||r.y!==r.targetY||t.revealProgress<.99)&&(i=!1)});const o=t.frameCanvas.transferToImageBitmap();t.mainContext.transferFromImageBitmap(o);const c=i&&t.revealProgress>=1,m=t.appProps.animationDuration;c&&n>=m?t.animationFrameId&&(cancelAnimationFrame(t.animationFrameId),t.frameContext.drawImage(t.imageBitmap,0,0),self.postMessage({type:I.ANIMATION_COMPLETE})):t.animationFrameId=requestAnimationFrame(r=>C(e,r))},et=()=>{t.animationFrameId&&cancelAnimationFrame(t.animationFrameId),S=new Function(t.appProps.movementFunctionCode)();const e=performance.now();t.revealProgress=0,C(e,e)},at=()=>{t.animationFrameId&&cancelAnimationFrame(t.animationFrameId),t.workerParticles=t.workerParticles.map(a=>{const i=P[t.appProps.startPosition](),n=Math.random()*t.appProps.delay,o=t.appProps.animationDuration-n;return{x:i.x,y:i.y,initialX:i.x,initialY:i.y,targetX:a.targetX,targetY:a.targetY,scale:1,opacity:1,color:a.color,revealProgress:0,revealThreshold:a.revealThreshold,delay:n,lifetime:o}}),t.frameContext.clearRect(0,0,t.frameCanvas.width,t.frameCanvas.height);const e=t.frameCanvas.transferToImageBitmap();t.mainContext.transferFromImageBitmap(e),t.animationFrameId&&cancelAnimationFrame(t.animationFrameId)},it=e=>{if(t.imageBitmap=e,t.frameCanvas&&t.mainCanvas){t.frameCanvas.width=t.imageBitmap.width,t.frameCanvas.height=t.imageBitmap.height,t.mainCanvas.width=t.imageBitmap.width,t.mainCanvas.height=t.imageBitmap.height,t.frameContext.drawImage(t.imageBitmap,0,0);const{validBlocks:a,blockHeight:i,blockWidth:n}=b(t.frameContext.getImageData(0,0,t.mainCanvas.width,t.mainCanvas.height),t.appProps.particleRadius);t.validBlocks=a,t.blockHeight=i,t.blockWidth=n,P=A({dimensions:{width:t.mainCanvas.width,height:t.mainCanvas.height},emitterX:t.appProps.emitterX,emitterY:t.appProps.emitterY,emitterSize:t.appProps.emitterSize,emitterAngle:t.appProps.emitterAngle}),t.frameContext.clearRect(0,0,t.frameCanvas.width,t.frameCanvas.height);const o=t.frameCanvas.transferToImageBitmap();t.mainContext.transferFromImageBitmap(o),t.workerParticles=x({validBlocks:t.validBlocks,radius:t.appProps.particleRadius,blockHeight:t.blockHeight,blockWidth:t.blockWidth,startPosition:t.appProps.startPosition,delay:t.appProps.delay,animationDuration:t.appProps.animationDuration})}},rt=e=>{const{appProps:a}=e;if(Object.assign(t.appProps,a),a.particleRadius!==void 0){t.frameContext.drawImage(t.imageBitmap,0,0);const{validBlocks:i,blockHeight:n,blockWidth:o}=b(t.frameContext.getImageData(0,0,t.mainCanvas.width,t.mainCanvas.height),t.appProps.particleRadius);t.validBlocks=i,t.blockHeight=n,t.blockWidth=o}if(a.startPosition!==void 0&&t.workerParticles.length&&t.workerParticles.forEach(i=>{const n=P[t.appProps.startPosition]();i.initialX=n.x,i.initialY=n.y,i.x=n.x,i.y=n.y}),(a.startPosition!==void 0||a.emitterX!==void 0||a.emitterY!==void 0||a.emitterSize!==void 0||a.emitterAngle!==void 0)&&(P=A({dimensions:{width:t.mainCanvas.width,height:t.mainCanvas.height},emitterX:t.appProps.emitterX,emitterY:t.appProps.emitterY,emitterSize:t.appProps.emitterSize,emitterAngle:t.appProps.emitterAngle})),t.workerParticles=x({validBlocks:t.validBlocks??new Uint8Array,radius:t.appProps.particleRadius,blockHeight:t.blockHeight,blockWidth:t.blockWidth,startPosition:t.appProps.startPosition,delay:t.appProps.delay,animationDuration:t.appProps.animationDuration}),self.postMessage({type:I.UPDATE_APP_PROPS,data:t.appProps}),t.animationFrameId){cancelAnimationFrame(t.animationFrameId);const i=performance.now();C(i,i)}};self.onmessage=e=>{const{payload:a,type:i}=e.data;switch(i){case f.INITIALIZE:{K(a);break}case f.PLAY:{et();break}case f.RESET:{at();break}case f.UPDATE_APP_PROPS:{rt(a);break}case f.UPDATE_BITMAP:{it(a);break}}}})();
