(function(){"use strict";const w="random",b="DEV_EXAMPLE",Y=`WIX 🤠
Particles!`,k="#ffffff",U=["#ff0000","#00ff00","#0000ff"],X={fontFamily:"Arial",fontSize:64,italic:!1,weight:600,letterSpacing:0,lineHeight:1.2},F=`// This function will be called twice for each particle, because all particles reach the target in two frames.
...
}`,W=()=>Object.assign({},{[b]:{code:`${T}${L}`},DEV_TWO_FRAMES:{code:`${T}${F}`},bezier:{code:`${T}${N}`},pulseColorCycle:{code:`${T}${q}`},timeDistortion:{code:`${T}${H}`},elasticPlop:{code:`${T}${$}`}},...B.map(({name:e,comment:a,definition:o})=>({[e]:{code:`${T}return (particle, animationStartTime, currentTime, canvasDimensions, animationDuration) => {
...
};`}}))),I=(e,a)=>{const{width:i,height:n,data:s}=e,l=Math.ceil(i/a),d=Math.ceil(n/a),r=new Uint8Array(Math.ceil(i/a)*Math.ceil(n/a));let c=0;for(let g=0;g<n;g+=a)for(let h=0;h<i;h+=a){let p=!1;for(let M=0;M<a&&!p;M++)for(let y=0;y<a&&!p;y++){const O=h+y,R=g+M;if(O<i&&R<n){const tt=(R*i+O)*4;s[tt+3]>10&&(p=!0)}}r[c++]=p?1:0}return{validBlocks:r,blockWidth:l,blockHeight:d}},E=(e,a,o)=>e+o*(a-e),C=e=>{e=e.replace(/^#/,"");const a=parseInt(e,16),o=a>>16&255,i=a>>8&255,n=a&255;return{r:o,g:i,b:n}},Z=(e,a,o)=>"#"+((1<<24)+(e<<16)+(a<<8)+o).toString(16).slice(1),A=(e,a)=>{if(!(e!=null&&e.length))return"#ffffff";if(e.length===1)return e[0];const i=Math.max(0,Math.min(1,a))*(e.length-1),n=Math.floor(i);if(n===e.length-1)return e[e.length-1];const s=i-n,l=C(e[n]),d=C(e[n+1]),r=Math.round(E(l.r,d.r,s)),c=Math.round(E(l.g,d.g,s)),g=Math.round(E(l.b,d.b,s));return Z(r,c,g)},x=({dimensions:{width:e,height:a}})=>({top:()=>({x:Math.random()*e,y:0}),center:()=>({x:Math.round(e/2),y:Math.round(a/2)}),bottom:()=>({x:Math.random()*e,y:a}),random:()=>({x:Math.random()*e,y:Math.random()*a}),left:()=>({x:0,y:Math.random()*a}),right:()=>({x:e,y:Math.random()*a}),"top-left":()=>({x:Math.random()*(e/5),y:Math.random()*(a/5)}),"top-right":()=>({x:e,y:Math.random()*(a/5)}),"bottom-left":()=>({x:Math.random()*(e/5),y:a-Math.random()*(a/5)}),"bottom-right":()=>({x:e-Math.random()*(e/5),y:a-Math.random()*(a/5)})});let D;const S={particleRadius:5,startPosition:w,selectedMovementFunction:b,movementFunctionCode:W()[b].code,text:Y,font:X,particleColors:U,animationDuration:3e3,enableBubbles:!1,particleSpread:3,startParticleOpacity:1,endParticleOpacity:1,startParticleSize:5,endParticleSize:1},t={workerParticles:[],bubbleParticles:[],imageBitmap:null,animationFrameId:0,frameCanvas:null,frameContext:null,mainCanvas:null,mainContext:null,validBlocks:null,blockHeight:0,blockWidth:0,appProps:S,revealProgress:0};let f;const j=async e=>{t.mainCanvas=e,t.mainContext=t.mainCanvas.getContext("bitmaprenderer"),t.frameCanvas=new OffscreenCanvas(t.mainCanvas.width,t.mainCanvas.height),t.frameContext=t.frameCanvas.getContext("2d",{willReadFrequently:!0})},z=e=>{const{imageBitmap:a,canvas:o,dimensions:i,appProps:n}=e;t.imageBitmap=a,Object.keys(n).length&&(t.appProps={...S,...n}),j(o),t.frameContext.drawImage(t.imageBitmap,0,0);const{validBlocks:s,blockHeight:l,blockWidth:d}=I(t.frameContext.getImageData(0,0,t.mainCanvas.width,t.mainCanvas.height),t.appProps.particleRadius);t.validBlocks=s,t.blockHeight=l,t.blockWidth=d,f=x({dimensions:i}),t.workerParticles=v({validBlocks:t.validBlocks,radius:t.appProps.particleRadius,blockHeight:t.blockHeight,blockWidth:t.blockWidth,startPosition:t.appProps.startPosition})},Q=(e,a,o,i,n=5)=>{const s=[];for(let l=0;l<n;l++){const d=Math.random()*Math.PI*2,r=.5+Math.random()*2;s.push({x:e,y:a,dx:Math.cos(d)*r,dy:Math.sin(d)*r-1,radius:2+Math.random()*5,color:o,opacity:.7+Math.random()*.3,createdAt:i,lifetime:_})}return s},v=({validBlocks:e,radius:a,blockHeight:o,blockWidth:i,startPosition:n})=>{const s=[];for(let l=0;l<o;l++)for(let d=0;d<i;d++){const r=l*i+d;if(e[r]){const c=d*a,g=l*a,{x:h,y:p}=f[n]();s.push({targetX:c,targetY:g,x:h,y:p,initialX:h,initialY:p,scale:1,opacity:1,color:k,revealProgress:0,revealThreshold:.97+Math.random()*.02,reachedTarget:!1,emittedBubbles:!1})}}return s},V=(e,a)=>{if(a>(e.revealThreshold||.99))return 1;if(a>.85&&Math.sqrt(Math.pow(e.x-e.targetX,2)+Math.pow(e.y-e.targetY,2))<=5){const n=(e.revealThreshold||.99)-.02,s=Math.max(0,(a-n)/.02);return Math.min(1,s)}return 0},K=e=>{const a=t.appProps.startParticleOpacity,o=t.appProps.endParticleOpacity;return a+(o-a)*e},G=e=>{const a=t.appProps.startParticleSize,o=t.appProps.endParticleSize;return a+(o-a)*e},P=(e,a)=>{let o=!0;t.frameContext.clearRect(0,0,t.frameCanvas.width,t.frameCanvas.height);const i=a-e;t.revealProgress=Math.min(1,i/t.appProps.animationDuration);for(let r=t.bubbleParticles.length-1;r>=0;r--){const c=t.bubbleParticles[r];c.x+=c.dx,c.y+=c.dy,c.dx+=(Math.random()-.5)*.1,c.dy-=.02;const g=a-c.createdAt,h=Math.min(1,g/c.lifetime),p=c.opacity*(1-h);t.frameContext.beginPath(),t.frameContext.arc(Math.floor(c.x),Math.floor(c.y),c.radius,0,Math.PI*2),t.frameContext.fillStyle=A(t.appProps.particleColors,h),t.frameContext.globalAlpha=p,t.frameContext.fill(),g>=c.lifetime&&t.bubbleParticles.splice(r,1)}t.frameContext.globalAlpha=1,t.workerParticles.forEach(r=>{D(r,e,a,{width:t.mainCanvas.width,height:t.mainCanvas.height},t.appProps.animationDuration);const c=V(r,t.revealProgress),g=K(t.revealProgress),h=G(t.revealProgress);if(c>0&&c<1){const p=Math.floor(t.appProps.particleRadius*(h||1));t.frameContext.globalAlpha=g*(1-c),t.frameContext.beginPath(),t.frameContext.arc(Math.floor(r.x)+p/2,Math.floor(r.y)+p/2,p/2,0,2*Math.PI),t.frameContext.fillStyle=t.appProps.particleColors.length?A(t.appProps.particleColors,t.revealProgress):r.color,t.frameContext.fill(),t.frameContext.globalAlpha=c*g,t.frameContext.drawImage(t.imageBitmap,r.targetX,r.targetY,h,h,Math.floor(r.x),Math.floor(r.y),h,h)}else if(c>=1)t.frameContext.globalAlpha=g,t.frameContext.drawImage(t.imageBitmap,r.targetX,r.targetY,t.appProps.particleRadius,t.appProps.particleRadius,Math.floor(r.x),Math.floor(r.y),t.appProps.particleRadius,t.appProps.particleRadius);else{const p=Math.floor(t.appProps.particleRadius*(h||1));t.frameContext.globalAlpha=g,t.frameContext.beginPath(),t.frameContext.arc(Math.floor(r.x)+p/2,Math.floor(r.y)+p/2,p/2,0,2*Math.PI),t.frameContext.fillStyle=t.appProps.particleColors.length?A(t.appProps.particleColors,t.revealProgress):r.color,t.frameContext.fill()}if(!r.emittedBubbles&&t.appProps.enableBubbles&&r.x===r.targetX&&r.y===r.targetY){r.emittedBubbles=!0;const p=Q(r.x,r.y,r.color,a,2+Math.floor(Math.random()*3));t.bubbleParticles.push(...p)}(r.x!==r.targetX||r.y!==r.targetY||t.revealProgress<.99)&&(o=!1)});const n=t.frameCanvas.transferToImageBitmap();t.mainContext.transferFromImageBitmap(n);const s=o&&t.revealProgress>=1,l=t.appProps.animationDuration+(t.appProps.enableBubbles?_:0);s&&i>=l?t.animationFrameId&&(cancelAnimationFrame(t.animationFrameId),t.bubbleParticles=[],t.frameContext.drawImage(t.imageBitmap,0,0),self.postMessage({type:u.ANIMATION_COMPLETE})):t.animationFrameId=requestAnimationFrame(r=>P(e,r))},J=()=>{D=new Function(t.appProps.movementFunctionCode)();const e=performance.now();t.revealProgress=0,t.bubbleParticles=[],t.workerParticles.forEach(a=>{a.emittedBubbles=!1}),P(e,e)};self.onmessage=e=>{const{payload:a,type:o}=e.data;switch(o){case m.INITIALIZE:{z(a),console.log("worker initializing"),self.postMessage({type:u.INITIALIZED,data:t.appProps});break}case m.PLAY:{t.animationFrameId&&cancelAnimationFrame(t.animationFrameId),t.bubbleParticles=[],J();break}case m.RESET:{t.animationFrameId&&cancelAnimationFrame(t.animationFrameId),t.workerParticles=t.workerParticles.map(n=>{const s=f[t.appProps.startPosition]();return{x:s.x,y:s.y,initialX:s.x,initialY:s.y,targetX:n.targetX,targetY:n.targetY,scale:1,opacity:1,color:n.color,revealProgress:0,revealThreshold:n.revealThreshold}}),t.frameContext.clearRect(0,0,t.frameCanvas.width,t.frameCanvas.height);const i=t.frameCanvas.transferToImageBitmap();t.mainContext.transferFromImageBitmap(i),t.animationFrameId&&cancelAnimationFrame(t.animationFrameId);break}case m.RESIZE_PARTICLE_RADIUS:{t.appProps.particleRadius=a,t.frameContext.drawImage(t.imageBitmap,0,0);const{validBlocks:i,blockHeight:n,blockWidth:s}=I(t.frameContext.getImageData(0,0,t.mainCanvas.width,t.mainCanvas.height),t.appProps.particleRadius);if(t.validBlocks=i,t.blockHeight=n,t.blockWidth=s,t.workerParticles=v({validBlocks:t.validBlocks,radius:t.appProps.particleRadius,blockHeight:t.blockHeight,blockWidth:t.blockWidth,startPosition:t.appProps.startPosition}),self.postMessage({type:u.UPDATE_APP_PROPS,data:t.appProps}),t.animationFrameId){cancelAnimationFrame(t.animationFrameId);const l=performance.now();P(l,l)}break}case m.UPDATE_START_POSITION:{if(t.appProps.startPosition=a,t.workerParticles.length){if(t.workerParticles.forEach(i=>{const n=f[t.appProps.startPosition]();i.initialX=n.x,i.initialY=n.y,i.x=n.x,i.y=n.y}),self.postMessage({type:u.UPDATE_APP_PROPS,data:t.appProps}),t.animationFrameId){cancelAnimationFrame(t.animationFrameId);const i=performance.now();P(i,i)}}else console.error("updateStartPosition failed, particles were not initialized",{workerParticles:t.workerParticles});break}case m.UPDATE_SELECTED_MOVEMENT_FUNCTION:{const{key:i,movementFunctionCode:n}=a??{};i&&(t.appProps.selectedMovementFunction=i),n!=null&&(t.appProps.movementFunctionCode=n),self.postMessage({type:u.UPDATE_APP_PROPS,data:t.appProps});break}case m.UPDATE_TEXT:{t.appProps.text=a,self.postMessage({type:u.UPDATE_APP_PROPS,data:t.appProps});break}case m.UPDATE_FONT:{t.appProps.font=a,self.postMessage({type:u.UPDATE_APP_PROPS,data:t.appProps});break}case m.UPDATE_PARTICLE_COLORS:{if(t.appProps.particleColors=a,a.length>0,self.postMessage({type:u.UPDATE_APP_PROPS,data:t.appProps}),t.animationFrameId){cancelAnimationFrame(t.animationFrameId);const i=performance.now();P(i,i)}break}case m.UPDATE_BITMAP:{if(t.imageBitmap=a,t.frameCanvas&&t.mainCanvas){t.frameCanvas.width=t.imageBitmap.width,t.frameCanvas.height=t.imageBitmap.height,t.mainCanvas.width=t.imageBitmap.width,t.mainCanvas.height=t.imageBitmap.height,t.frameContext.drawImage(t.imageBitmap,0,0);const{validBlocks:i,blockHeight:n,blockWidth:s}=I(t.frameContext.getImageData(0,0,t.mainCanvas.width,t.mainCanvas.height),t.appProps.particleRadius);t.validBlocks=i,t.blockHeight=n,t.blockWidth=s,f=x({dimensions:{width:t.mainCanvas.width,height:t.mainCanvas.height}}),t.frameContext.clearRect(0,0,t.frameCanvas.width,t.frameCanvas.height);const l=t.frameCanvas.transferToImageBitmap();t.mainContext.transferFromImageBitmap(l),t.workerParticles=v({validBlocks:t.validBlocks,radius:t.appProps.particleRadius,blockHeight:t.blockHeight,blockWidth:t.blockWidth,startPosition:t.appProps.startPosition})}break}case m.UPDATE_ANIMATION_DURATION:{t.appProps.animationDuration=a,self.postMessage({type:u.UPDATE_APP_PROPS,data:t.appProps}),t.animationFrameId&&(t.bubbleParticles=[]);break}case m.UPDATE_ENABLE_BUBBLES:{t.appProps.enableBubbles=a,self.postMessage({type:u.UPDATE_APP_PROPS,data:t.appProps});break}case m.UPDATE_PARTICLE_SPREAD:{t.appProps.particleSpread=a,self.postMessage({type:u.UPDATE_APP_PROPS,data:t.appProps});break}case m.UPDATE_START_PARTICLE_OPACITY:{if(t.appProps.startParticleOpacity=a,self.postMessage({type:u.UPDATE_APP_PROPS,data:t.appProps}),t.animationFrameId){cancelAnimationFrame(t.animationFrameId);const i=performance.now();P(i,i)}break}case m.UPDATE_END_PARTICLE_OPACITY:{if(t.appProps.endParticleOpacity=a,self.postMessage({type:u.UPDATE_APP_PROPS,data:t.appProps}),t.animationFrameId){cancelAnimationFrame(t.animationFrameId);const i=performance.now();P(i,i)}break}case m.UPDATE_START_PARTICLE_SIZE:{if(t.appProps.startParticleSize=a,self.postMessage({type:u.UPDATE_APP_PROPS,data:t.appProps}),t.animationFrameId){cancelAnimationFrame(t.animationFrameId);const i=performance.now();P(i,i)}break}case m.UPDATE_END_PARTICLE_SIZE:{if(t.appProps.endParticleSize=a,self.postMessage({type:u.UPDATE_APP_PROPS,data:t.appProps}),t.animationFrameId){cancelAnimationFrame(t.animationFrameId);const i=performance.now();P(i,i)}break}}}})();
