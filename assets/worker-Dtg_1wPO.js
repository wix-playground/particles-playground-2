(function(){"use strict";const X="linear",w="linear",L="random",E="backInOut",F=`WIX 🤠
Particles!`,U="#ffffff",k=["#ff0000","#00ff00","#0000ff"],B="left-to-right",N={fontFamily:"Arial",fontSize:64,italic:!1,weight:600},q=`// This function will be called twice for each particle, because all particles reach the target in two frames.
...
return (particle, animationStartTime, currentTime, canvasDimensions, animationDuration) => {
  ...
  t < 0.5
    ...
    */`},{name:"elasticIn",definition:` const elasticIn = (x) => {
    ...
    }`,comment:""}],V=`return (particle, animationStartTime, currentTime, canvasDimensions, animationDuration) => {
    const totalElapsedTime = currentTime - animationStartTime;
...
}`,J=()=>Object.assign({},{[E]:{code:`${f}${H}`},DEV_TWO_FRAMES:{code:`${f}${q}`},bezier:{code:`${f}${V}`},pulseColorCycle:{code:`${f}${Q}`},timeDistortion:{code:`${f}${K}`},elasticPlop:{code:`${f}${G}`}},...Z.map(({name:e,comment:a,definition:r})=>({[e]:{code:`${f}return (particle, animationStartTime, currentTime, canvasDimensions, animationDuration) => {
...
};`}}))),A=(e,a)=>{const{width:i,height:n,data:s}=e,u=Math.ceil(i/a),c=Math.ceil(n/a),o=new Uint8Array(Math.ceil(i/a)*Math.ceil(n/a));let l=0;for(let p=0;p<n;p+=a)for(let m=0;m<i;m+=a){let g=!1;for(let h=0;h<a&&!g;h++)for(let d=0;d<a&&!g;d++){const v=m+d,M=p+h;if(v<i&&M<n){const D=(M*i+v)*4;s[D+3]>10&&(g=!0)}}o[l++]=g?1:0}return{validBlocks:o,blockWidth:u,blockHeight:c}},y=(e,a,r)=>e+r*(a-e),tt=e=>{e=e.replace(/^#/,"");const a=parseInt(e,16),r=a>>16&255,i=a>>8&255,n=a&255;return{r,g:i,b:n}},et=e=>{const a=e.match(/hsl\((\d+),\s*(\d+)%,\s*(\d+)%\)/);if(!a)return console.warn("Invalid HSL color format:",e),{r:0,g:0,b:0};const r=parseInt(a[1])/360,i=parseInt(a[2])/100,n=parseInt(a[3])/100,s=(l,p,m)=>(m<0&&(m+=1),m>1&&(m-=1),m<1/6?l+(p-l)*6*m:m<1/2?p:m<2/3?l+(p-l)*(2/3-m)*6:l);let u,c,o;if(i===0)u=c=o=n;else{const l=n<.5?n*(1+i):n+i-n*i,p=2*n-l;u=s(p,l,r+1/3),c=s(p,l,r),o=s(p,l,r-1/3)}return{r:Math.round(u*255),g:Math.round(c*255),b:Math.round(o*255)}},_=e=>e.startsWith("hsl(")?et(e):tt(e),at=(e,a,r)=>"#"+((1<<24)+(e<<16)+(a<<8)+r).toString(16).slice(1),O=(e,a)=>{if(!(e!=null&&e.length))return"#ffffff";if(e.length===1)return e[0];const i=Math.max(0,Math.min(1,a))*(e.length-1),n=Math.floor(i);if(n===e.length-1)return e[e.length-1];const s=i-n,u=_(e[n]),c=_(e[n+1]),o=Math.round(y(u.r,c.r,s)),l=Math.round(y(u.g,c.g,s)),p=Math.round(y(u.b,c.b,s));return at(o,l,p)},b=({dimensions:{width:e,height:a},emitterX:r=e/2,emitterY:i=a/2,emitterSize:n=100,emitterAngle:s=0})=>({top:()=>({x:Math.random()*e,y:0}),center:()=>({x:Math.round(e/2),y:Math.round(a/2)}),bottom:()=>({x:Math.random()*e,y:a}),random:()=>({x:Math.random()*e,y:Math.random()*a}),left:()=>({x:0,y:Math.random()*a}),right:()=>({x:e,y:Math.random()*a}),"top-left":()=>({x:Math.random()*(e/5),y:Math.random()*(a/5)}),"top-right":()=>({x:e,y:Math.random()*(a/5)}),"bottom-left":()=>({x:Math.random()*(e/5),y:a-Math.random()*(a/5)}),"bottom-right":()=>({x:e-Math.random()*(e/5),y:a-Math.random()*(a/5)}),canvasEdges:()=>{const c=Math.floor(Math.random()*4);return c===0?{x:Math.random()*e,y:0}:c===1?{x:Math.random()*e,y:a}:c===2?{x:0,y:Math.random()*a}:{x:e,y:Math.random()*a}},topLeft:()=>({x:0,y:0}),emitterPoint:()=>({x:r,y:i}),emitterCircle:()=>{const c=Math.random()*2*Math.PI,o=Math.random()*n;return{x:r+o*Math.cos(c),y:i+o*Math.sin(c)}},emitterSquare:()=>({x:r+(Math.random()-.5)*n,y:i+(Math.random()-.5)*n}),emitterHLine:()=>{const c=s*(Math.PI/180),o=(Math.random()-.5)*n;return{x:r+o*Math.cos(c),y:i+o*Math.sin(c)}},emitterVLine:()=>{const c=(s+90)*(Math.PI/180),o=(Math.random()-.5)*n;return{x:r+o*Math.cos(c),y:i+o*Math.sin(c)}},enterTopTextWidth:()=>({x:e*.2+Math.random()*e*.6,y:a*.3}),enterBottomTextWidth:()=>({x:e*.2+Math.random()*e*.6,y:a*.7}),enterLeftTextHeight:()=>({x:e*.2,y:a*.3+Math.random()*a*.4}),enterRightTextHeight:()=>({x:e*.8,y:a*.3+Math.random()*a*.4})});let R;const S={particleRadius:5,startPosition:L,selectedMovementFunction:E,movementFunctionCode:J()[E].code,text:F,font:N,particleColors:k,animationDuration:3e3,particleSpread:3,startParticleOpacity:1,endParticleOpacity:1,startParticleSize:5,endParticleSize:1,particleSizeEasing:X,particleOpacityEasing:w,delay:0,emitterX:W,emitterY:$,emitterSize:z,emitterAngle:j,enableRevealAnimation:!1,revealDirection:B},t={workerParticles:[],imageBitmap:null,animationFrameId:0,frameCanvas:null,frameContext:null,mainCanvas:null,mainContext:null,validBlocks:null,blockHeight:0,blockWidth:0,appProps:S,revealProgress:0};let I;const it=async e=>{t.mainCanvas=e,t.mainContext=t.mainCanvas.getContext("bitmaprenderer"),t.frameCanvas=new OffscreenCanvas(t.mainCanvas.width,t.mainCanvas.height),t.frameContext=t.frameCanvas.getContext("2d",{willReadFrequently:!0})},nt=e=>{const{imageBitmap:a,canvas:r,dimensions:i,appProps:n}=e;t.imageBitmap=a,Object.keys(n).length&&(t.appProps={...S,...n}),it(r),t.frameContext.drawImage(t.imageBitmap,0,0);const{validBlocks:s,blockHeight:u,blockWidth:c}=A(t.frameContext.getImageData(0,0,t.mainCanvas.width,t.mainCanvas.height),t.appProps.particleRadius);t.validBlocks=s,t.blockHeight=u,t.blockWidth=c,I=b({dimensions:i,emitterX:t.appProps.emitterX,emitterY:t.appProps.emitterY,emitterSize:t.appProps.emitterSize,emitterAngle:t.appProps.emitterAngle}),t.workerParticles=C({validBlocks:t.validBlocks,radius:t.appProps.particleRadius,blockHeight:t.blockHeight,blockWidth:t.blockWidth,startPosition:t.appProps.startPosition,delay:t.appProps.delay,animationDuration:t.appProps.animationDuration,revealAnimation:t.appProps.enableRevealAnimation}),self.postMessage({type:P.INITIALIZED,data:t.appProps})},C=({validBlocks:e,radius:a,blockHeight:r,blockWidth:i,startPosition:n,delay:s,animationDuration:u,revealAnimation:c})=>{const o=[];for(let l=0;l<r;l++)for(let p=0;p<i;p++){const m=l*i+p;if(e[m]){const g=p*a,h=l*a,{x:d,y:v}=c?{x:g,y:h}:I[n](),M=c?0:Math.random()*s,D=u-M;o.push({targetX:g,targetY:h,x:d,y:v,initialX:d,initialY:v,scale:1,opacity:1,color:U,revealProgress:0,revealThreshold:.97+Math.random()*.02,reachedTarget:!1,emittedBubbles:!1,delay:M,lifetime:D})}}return o},rt=e=>{if(e.length===0)return{width:0,height:0,minX:0,minY:0,maxX:0,maxY:0};let a=1/0,r=1/0,i=-1/0,n=-1/0;return e.forEach(s=>{a=Math.min(a,s.targetX),r=Math.min(r,s.targetY),i=Math.max(i,s.targetX+t.appProps.particleRadius),n=Math.max(n,s.targetY+t.appProps.particleRadius)}),{minX:a,minY:r,maxX:i,maxY:n,width:i-a,height:n-r}},ot=(e,a,r,i)=>{switch(r){case"left-to-right":{const n=i.minX+a*i.width;return e.targetX<=n}case"right-to-left":{const n=i.maxX-a*i.width;return e.targetX>=n}case"top-to-bottom":{const n=i.minY+a*i.height;return e.targetY<=n}case"bottom-to-top":{const n=i.maxY-a*i.height;return e.targetY>=n}default:return!0}},st=(e,a)=>{if(a>(e.revealThreshold||.99))return 1;if(a>.85&&Math.sqrt(Math.pow(e.x-e.targetX,2)+Math.pow(e.y-e.targetY,2))<=5){const n=(e.revealThreshold||.99)-.02,s=Math.max(0,(a-n)/.02);return Math.min(1,s)}return 0},ct=e=>{const a=t.appProps.startParticleOpacity,r=t.appProps.endParticleOpacity,i=lt(e,t.appProps.particleOpacityEasing);if(t.appProps.particleOpacityEasing!=="linear"){const n=Math.min(a,r),s=Math.max(a,r);return n+(s-n)*i}return a+(r-a)*i},lt=(e,a)=>{switch(a){case"bell":return Math.sin(e*Math.PI);case"linear":return e;case"multiPulse":const i=e*5%1;return Math.sin(i*Math.PI);default:return 1}},pt=(e,a)=>{switch(a){case"bell":return Math.sin(e*Math.PI);case"linear":return e;case"multiPulse":const i=e*5%1;return Math.sin(i*Math.PI);default:return 1}},mt=e=>{const a=t.appProps.startParticleSize,r=t.appProps.endParticleSize,i=pt(e,t.appProps.particleSizeEasing);if(t.appProps.particleSizeEasing!=="linear"){const n=Math.min(a,r),s=Math.max(a,r);return n+(s-n)*i}return a+(r-a)*i},Y=(e,a,r)=>{t.frameContext.clearRect(0,0,t.frameCanvas.width,t.frameCanvas.height);const i=a-e;t.revealProgress=Math.min(1,i/t.appProps.animationDuration),t.frameContext.globalAlpha=1,t.workerParticles.forEach(s=>{ot(s,t.revealProgress,t.appProps.revealDirection,r)&&t.frameContext.drawImage(t.imageBitmap,s.targetX,s.targetY,t.appProps.particleRadius,t.appProps.particleRadius,Math.floor(s.x),Math.floor(s.y),t.appProps.particleRadius,t.appProps.particleRadius)});const n=t.frameCanvas.transferToImageBitmap();if(t.mainContext.transferFromImageBitmap(n),t.revealProgress<1)t.animationFrameId=requestAnimationFrame(s=>Y(e,s,r));else{t.frameContext.drawImage(t.imageBitmap,0,0);const s=t.frameCanvas.transferToImageBitmap();t.mainContext.transferFromImageBitmap(s),self.postMessage({type:P.ANIMATION_COMPLETE})}},x=(e,a)=>{let r=!0;t.frameContext.clearRect(0,0,t.frameCanvas.width,t.frameCanvas.height);const i=a-e;t.revealProgress=Math.min(1,i/t.appProps.animationDuration),t.frameContext.globalAlpha=1,t.workerParticles.forEach(o=>{if(o.delay>a-e)return;const l=i-o.delay,p=Math.max(0,Math.min(1,l/o.lifetime));R(o,e,a,{width:t.mainCanvas.width,height:t.mainCanvas.height},t.appProps.animationDuration);const m=st(o,t.revealProgress),g=ct(p),h=mt(p);if(m>0&&m<1){const d=t.appProps.particleRadius*(h||1);t.frameContext.globalAlpha=g*(1-m),t.frameContext.beginPath(),t.frameContext.arc(Math.floor(o.x)+d/2,Math.floor(o.y)+d/2,d/2,0,2*Math.PI),t.frameContext.fillStyle=t.appProps.particleColors.length?O(t.appProps.particleColors,t.revealProgress):o.color,t.frameContext.fill(),t.frameContext.globalAlpha=m*g,t.frameContext.drawImage(t.imageBitmap,o.targetX,o.targetY,h,h,Math.floor(o.x),Math.floor(o.y),h,h)}else if(m>=1)t.frameContext.globalAlpha=1,t.frameContext.drawImage(t.imageBitmap,o.targetX,o.targetY,t.appProps.particleRadius,t.appProps.particleRadius,Math.floor(o.x),Math.floor(o.y),t.appProps.particleRadius,t.appProps.particleRadius);else{const d=t.appProps.particleRadius*(h||1);t.frameContext.globalAlpha=g,t.frameContext.beginPath(),t.frameContext.arc(Math.floor(o.x)+d/2,Math.floor(o.y)+d/2,d/2,0,2*Math.PI),t.frameContext.fillStyle=t.appProps.particleColors.length?O(t.appProps.particleColors,t.revealProgress):o.color,t.frameContext.fill()}(o.x!==o.targetX||o.y!==o.targetY||t.revealProgress<.99)&&(r=!1)});const n=t.frameCanvas.transferToImageBitmap();t.mainContext.transferFromImageBitmap(n);const s=r&&t.revealProgress>=1,u=t.appProps.animationDuration;s&&i>=u?t.animationFrameId&&(cancelAnimationFrame(t.animationFrameId),t.frameContext.drawImage(t.imageBitmap,0,0),self.postMessage({type:P.ANIMATION_COMPLETE})):t.animationFrameId=requestAnimationFrame(o=>x(e,o))},ut=()=>{t.animationFrameId&&cancelAnimationFrame(t.animationFrameId),R=new Function(t.appProps.movementFunctionCode)();const e=performance.now();if(t.revealProgress=0,t.appProps.enableRevealAnimation){const a=rt(t.workerParticles);t.frameContext.globalAlpha=1,Y(e,e,a)}else x(e,e)},dt=()=>{t.animationFrameId&&cancelAnimationFrame(t.animationFrameId),t.workerParticles=t.workerParticles.map(a=>{const r=I[t.appProps.startPosition](),i=Math.random()*t.appProps.delay,n=t.appProps.animationDuration-i;return{x:r.x,y:r.y,initialX:r.x,initialY:r.y,targetX:a.targetX,targetY:a.targetY,scale:1,opacity:1,color:a.color,revealProgress:0,revealThreshold:a.revealThreshold,delay:i,lifetime:n}}),t.frameContext.clearRect(0,0,t.frameCanvas.width,t.frameCanvas.height);const e=t.frameCanvas.transferToImageBitmap();t.mainContext.transferFromImageBitmap(e),t.animationFrameId&&cancelAnimationFrame(t.animationFrameId)},ht=e=>{if(t.imageBitmap=e,t.frameCanvas&&t.mainCanvas){t.frameCanvas.width=t.imageBitmap.width,t.frameCanvas.height=t.imageBitmap.height,t.mainCanvas.width=t.imageBitmap.width,t.mainCanvas.height=t.imageBitmap.height,t.frameContext.drawImage(t.imageBitmap,0,0);const{validBlocks:a,blockHeight:r,blockWidth:i}=A(t.frameContext.getImageData(0,0,t.mainCanvas.width,t.mainCanvas.height),t.appProps.particleRadius);t.validBlocks=a,t.blockHeight=r,t.blockWidth=i,I=b({dimensions:{width:t.mainCanvas.width,height:t.mainCanvas.height},emitterX:t.appProps.emitterX,emitterY:t.appProps.emitterY,emitterSize:t.appProps.emitterSize,emitterAngle:t.appProps.emitterAngle}),t.frameContext.clearRect(0,0,t.frameCanvas.width,t.frameCanvas.height);const n=t.frameCanvas.transferToImageBitmap();t.mainContext.transferFromImageBitmap(n),t.workerParticles=C({validBlocks:t.validBlocks,radius:t.appProps.particleRadius,blockHeight:t.blockHeight,blockWidth:t.blockWidth,startPosition:t.appProps.startPosition,delay:t.appProps.delay,animationDuration:t.appProps.animationDuration,revealAnimation:t.appProps.enableRevealAnimation})}},gt=e=>{const{appProps:a,shouldUpdateStartCoordinatesConfig:r,shouldRegenerateImageBlocks:i}=e;if(Object.assign(t.appProps,a),i){t.frameContext.drawImage(t.imageBitmap,0,0);const{validBlocks:n,blockHeight:s,blockWidth:u}=A(t.frameContext.getImageData(0,0,t.mainCanvas.width,t.mainCanvas.height),t.appProps.particleRadius);t.validBlocks=n,t.blockHeight=s,t.blockWidth=u}if(r&&(I=b({dimensions:{width:t.mainCanvas.width,height:t.mainCanvas.height},emitterX:t.appProps.emitterX,emitterY:t.appProps.emitterY,emitterSize:t.appProps.emitterSize,emitterAngle:t.appProps.emitterAngle})),t.workerParticles=C({validBlocks:t.validBlocks??new Uint8Array,radius:t.appProps.particleRadius,blockHeight:t.blockHeight,blockWidth:t.blockWidth,startPosition:t.appProps.startPosition,delay:t.appProps.delay,animationDuration:t.appProps.animationDuration,revealAnimation:t.appProps.enableRevealAnimation}),self.postMessage({type:P.UPDATE_APP_PROPS,data:t.appProps}),t.animationFrameId){cancelAnimationFrame(t.animationFrameId);const n=performance.now();x(n,n)}};self.onmessage=e=>{const{payload:a,type:r}=e.data;switch(r){case T.INITIALIZE:{nt(a);break}case T.PLAY:{ut();break}case T.RESET:{dt();break}case T.UPDATE_APP_PROPS:{gt(a);break}case T.UPDATE_BITMAP:{ht(a);break}}}})();
