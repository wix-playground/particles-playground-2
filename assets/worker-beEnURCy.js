(function(){"use strict";const Y="linear",R="linear",X="random",y="backInOut",w=`WIX 🤠
Particles!`,L="#ffffff",k=["#ff0000","#00ff00","#0000ff"],F={fontFamily:"Arial",fontSize:64,italic:!1,weight:600},U=`// This function will be called twice for each particle, because all particles reach the target in two frames.
...
return (particle, animationStartTime, currentTime, canvasDimensions, animationDuration) => {
  ...
  t < 0.5
    ...
    */`},{name:"elasticIn",definition:` const elasticIn = (x) => {
    ...
    }`,comment:""}],z=`return (particle, animationStartTime, currentTime, canvasDimensions, animationDuration) => {
    const totalElapsedTime = currentTime - animationStartTime;
...
}`,Z=`return (particle, animationStartTime, currentTime, canvasDimensions, animationDuration) => {
    const progress = Math.min((currentTime - animationStartTime) / animationDuration, 1);
...
}`,V=()=>Object.assign({},{[y]:{code:`${T}${B}`},DEV_TWO_FRAMES:{code:`${T}${U}`},bezier:{code:`${T}${z}`},pulseColorCycle:{code:`${T}${j}`},timeDistortion:{code:`${T}${Z}`},elasticPlop:{code:`${T}${Q}`}},...$.map(({name:e,comment:a,definition:i})=>({[e]:{code:`${T}return (particle, animationStartTime, currentTime, canvasDimensions, animationDuration) => {
...
};`}}))),E=(e,a)=>{const{width:n,height:r,data:c}=e,m=Math.ceil(n/a),s=Math.ceil(r/a),o=new Uint8Array(Math.ceil(n/a)*Math.ceil(r/a));let l=0;for(let u=0;u<r;u+=a)for(let p=0;p<n;p+=a){let g=!1;for(let h=0;h<a&&!g;h++)for(let d=0;d<a&&!g;d++){const M=p+d,v=u+h;if(M<n&&v<r){const mt=(v*n+M)*4;c[mt+3]>10&&(g=!0)}}o[l++]=g?1:0}return{validBlocks:o,blockWidth:m,blockHeight:s}},b=(e,a,i)=>e+i*(a-e),K=e=>{e=e.replace(/^#/,"");const a=parseInt(e,16),i=a>>16&255,n=a>>8&255,r=a&255;return{r:i,g:n,b:r}},G=e=>{const a=e.match(/hsl\((\d+),\s*(\d+)%,\s*(\d+)%\)/);if(!a)return console.warn("Invalid HSL color format:",e),{r:0,g:0,b:0};const i=parseInt(a[1])/360,n=parseInt(a[2])/100,r=parseInt(a[3])/100,c=(l,u,p)=>(p<0&&(p+=1),p>1&&(p-=1),p<1/6?l+(u-l)*6*p:p<1/2?u:p<2/3?l+(u-l)*(2/3-p)*6:l);let m,s,o;if(n===0)m=s=o=r;else{const l=r<.5?r*(1+n):r+n-r*n,u=2*r-l;m=c(u,l,i+1/3),s=c(u,l,i),o=c(u,l,i-1/3)}return{r:Math.round(m*255),g:Math.round(s*255),b:Math.round(o*255)}},D=e=>e.startsWith("hsl(")?G(e):K(e),J=(e,a,i)=>"#"+((1<<24)+(e<<16)+(a<<8)+i).toString(16).slice(1),_=(e,a)=>{if(!(e!=null&&e.length))return"#ffffff";if(e.length===1)return e[0];const n=Math.max(0,Math.min(1,a))*(e.length-1),r=Math.floor(n);if(r===e.length-1)return e[e.length-1];const c=n-r,m=D(e[r]),s=D(e[r+1]),o=Math.round(b(m.r,s.r,c)),l=Math.round(b(m.g,s.g,c)),u=Math.round(b(m.b,s.b,c));return J(o,l,u)},A=({dimensions:{width:e,height:a},emitterX:i=e/2,emitterY:n=a/2,emitterSize:r=100,emitterAngle:c=0})=>({top:()=>({x:Math.random()*e,y:0}),center:()=>({x:Math.round(e/2),y:Math.round(a/2)}),bottom:()=>({x:Math.random()*e,y:a}),random:()=>({x:Math.random()*e,y:Math.random()*a}),left:()=>({x:0,y:Math.random()*a}),right:()=>({x:e,y:Math.random()*a}),"top-left":()=>({x:Math.random()*(e/5),y:Math.random()*(a/5)}),"top-right":()=>({x:e,y:Math.random()*(a/5)}),"bottom-left":()=>({x:Math.random()*(e/5),y:a-Math.random()*(a/5)}),"bottom-right":()=>({x:e-Math.random()*(e/5),y:a-Math.random()*(a/5)}),canvasEdges:()=>{const s=Math.floor(Math.random()*4);return s===0?{x:Math.random()*e,y:0}:s===1?{x:Math.random()*e,y:a}:s===2?{x:0,y:Math.random()*a}:{x:e,y:Math.random()*a}},topLeft:()=>({x:0,y:0}),emitterPoint:()=>({x:i,y:n}),emitterCircle:()=>{const s=Math.random()*2*Math.PI,o=Math.random()*r;return{x:i+o*Math.cos(s),y:n+o*Math.sin(s)}},emitterSquare:()=>({x:i+(Math.random()-.5)*r,y:n+(Math.random()-.5)*r}),emitterHLine:()=>{const s=c*(Math.PI/180),o=(Math.random()-.5)*r;return{x:i+o*Math.cos(s),y:n+o*Math.sin(s)}},emitterVLine:()=>{const s=(c+90)*(Math.PI/180),o=(Math.random()-.5)*r;return{x:i+o*Math.cos(s),y:n+o*Math.sin(s)}},enterTopTextWidth:()=>({x:e*.2+Math.random()*e*.6,y:a*.3}),enterBottomTextWidth:()=>({x:e*.2+Math.random()*e*.6,y:a*.7}),enterLeftTextHeight:()=>({x:e*.2,y:a*.3+Math.random()*a*.4}),enterRightTextHeight:()=>({x:e*.8,y:a*.3+Math.random()*a*.4})});let S;const O={particleRadius:5,startPosition:X,selectedMovementFunction:y,movementFunctionCode:V()[y].code,text:w,font:F,particleColors:k,animationDuration:3e3,particleSpread:3,startParticleOpacity:1,endParticleOpacity:1,startParticleSize:5,endParticleSize:1,particleSizeEasing:Y,particleOpacityEasing:R,delay:0,emitterX:N,emitterY:q,emitterSize:H,emitterAngle:W},t={workerParticles:[],imageBitmap:null,animationFrameId:0,frameCanvas:null,frameContext:null,mainCanvas:null,mainContext:null,validBlocks:null,blockHeight:0,blockWidth:0,appProps:O,revealProgress:0};let P;const tt=async e=>{t.mainCanvas=e,t.mainContext=t.mainCanvas.getContext("bitmaprenderer"),t.frameCanvas=new OffscreenCanvas(t.mainCanvas.width,t.mainCanvas.height),t.frameContext=t.frameCanvas.getContext("2d",{willReadFrequently:!0})},et=e=>{const{imageBitmap:a,canvas:i,dimensions:n,appProps:r}=e;t.imageBitmap=a,Object.keys(r).length&&(t.appProps={...O,...r}),tt(i),t.frameContext.drawImage(t.imageBitmap,0,0);const{validBlocks:c,blockHeight:m,blockWidth:s}=E(t.frameContext.getImageData(0,0,t.mainCanvas.width,t.mainCanvas.height),t.appProps.particleRadius);t.validBlocks=c,t.blockHeight=m,t.blockWidth=s,P=A({dimensions:n,emitterX:t.appProps.emitterX,emitterY:t.appProps.emitterY,emitterSize:t.appProps.emitterSize,emitterAngle:t.appProps.emitterAngle}),t.workerParticles=C({validBlocks:t.validBlocks,radius:t.appProps.particleRadius,blockHeight:t.blockHeight,blockWidth:t.blockWidth,startPosition:t.appProps.startPosition,delay:t.appProps.delay,animationDuration:t.appProps.animationDuration}),self.postMessage({type:I.INITIALIZED,data:t.appProps})},C=({validBlocks:e,radius:a,blockHeight:i,blockWidth:n,startPosition:r,delay:c,animationDuration:m})=>{const s=[];for(let o=0;o<i;o++)for(let l=0;l<n;l++){const u=o*n+l;if(e[u]){const p=l*a,g=o*a,{x:h,y:d}=P[r](),M=Math.random()*c,v=m-M;s.push({targetX:p,targetY:g,x:h,y:d,initialX:h,initialY:d,scale:1,opacity:1,color:L,revealProgress:0,revealThreshold:.97+Math.random()*.02,reachedTarget:!1,emittedBubbles:!1,delay:M,lifetime:v})}}return s},at=(e,a)=>{if(a>(e.revealThreshold||.99))return 1;if(a>.85&&Math.sqrt(Math.pow(e.x-e.targetX,2)+Math.pow(e.y-e.targetY,2))<=5){const r=(e.revealThreshold||.99)-.02,c=Math.max(0,(a-r)/.02);return Math.min(1,c)}return 0},it=e=>{const a=t.appProps.startParticleOpacity,i=t.appProps.endParticleOpacity,n=nt(e,t.appProps.particleOpacityEasing);if(t.appProps.particleOpacityEasing!=="linear"){const r=Math.min(a,i),c=Math.max(a,i);return r+(c-r)*n}return a+(i-a)*n},nt=(e,a)=>{switch(a){case"bell":return Math.sin(e*Math.PI);case"linear":return e;case"multiPulse":const n=e*5%1;return Math.sin(n*Math.PI);default:return 1}},rt=(e,a)=>{switch(a){case"bell":return Math.sin(e*Math.PI);case"linear":return e;case"multiPulse":const n=e*5%1;return Math.sin(n*Math.PI);default:return 1}},ot=e=>{const a=t.appProps.startParticleSize,i=t.appProps.endParticleSize,n=rt(e,t.appProps.particleSizeEasing);if(t.appProps.particleSizeEasing!=="linear"){const r=Math.min(a,i),c=Math.max(a,i);return r+(c-r)*n}return a+(i-a)*n},x=(e,a)=>{let i=!0;t.frameContext.clearRect(0,0,t.frameCanvas.width,t.frameCanvas.height);const n=a-e;t.revealProgress=Math.min(1,n/t.appProps.animationDuration),t.frameContext.globalAlpha=1,t.workerParticles.forEach(o=>{if(o.delay>a-e)return;const l=n-o.delay,u=Math.max(0,Math.min(1,l/o.lifetime));S(o,e,a,{width:t.mainCanvas.width,height:t.mainCanvas.height},t.appProps.animationDuration);const p=at(o,t.revealProgress),g=it(u),h=ot(u);if(p>0&&p<1){const d=t.appProps.particleRadius*(h||1);t.frameContext.globalAlpha=g*(1-p),t.frameContext.beginPath(),t.frameContext.arc(Math.floor(o.x)+d/2,Math.floor(o.y)+d/2,d/2,0,2*Math.PI),t.frameContext.fillStyle=t.appProps.particleColors.length?_(t.appProps.particleColors,t.revealProgress):o.color,t.frameContext.fill(),t.frameContext.globalAlpha=p*g,t.frameContext.drawImage(t.imageBitmap,o.targetX,o.targetY,h,h,Math.floor(o.x),Math.floor(o.y),h,h)}else if(p>=1)t.frameContext.globalAlpha=1,t.frameContext.drawImage(t.imageBitmap,o.targetX,o.targetY,t.appProps.particleRadius,t.appProps.particleRadius,Math.floor(o.x),Math.floor(o.y),t.appProps.particleRadius,t.appProps.particleRadius);else{const d=t.appProps.particleRadius*(h||1);t.frameContext.globalAlpha=g,t.frameContext.beginPath(),t.frameContext.arc(Math.floor(o.x)+d/2,Math.floor(o.y)+d/2,d/2,0,2*Math.PI),t.frameContext.fillStyle=t.appProps.particleColors.length?_(t.appProps.particleColors,t.revealProgress):o.color,t.frameContext.fill()}(o.x!==o.targetX||o.y!==o.targetY||t.revealProgress<.99)&&(i=!1)});const r=t.frameCanvas.transferToImageBitmap();t.mainContext.transferFromImageBitmap(r);const c=i&&t.revealProgress>=1,m=t.appProps.animationDuration;c&&n>=m?t.animationFrameId&&(cancelAnimationFrame(t.animationFrameId),t.frameContext.drawImage(t.imageBitmap,0,0),self.postMessage({type:I.ANIMATION_COMPLETE})):t.animationFrameId=requestAnimationFrame(o=>x(e,o))},st=()=>{t.animationFrameId&&cancelAnimationFrame(t.animationFrameId),S=new Function(t.appProps.movementFunctionCode)();const e=performance.now();t.revealProgress=0,x(e,e)},ct=()=>{t.animationFrameId&&cancelAnimationFrame(t.animationFrameId),t.workerParticles=t.workerParticles.map(a=>{const i=P[t.appProps.startPosition](),n=Math.random()*t.appProps.delay,r=t.appProps.animationDuration-n;return{x:i.x,y:i.y,initialX:i.x,initialY:i.y,targetX:a.targetX,targetY:a.targetY,scale:1,opacity:1,color:a.color,revealProgress:0,revealThreshold:a.revealThreshold,delay:n,lifetime:r}}),t.frameContext.clearRect(0,0,t.frameCanvas.width,t.frameCanvas.height);const e=t.frameCanvas.transferToImageBitmap();t.mainContext.transferFromImageBitmap(e),t.animationFrameId&&cancelAnimationFrame(t.animationFrameId)},lt=e=>{if(t.imageBitmap=e,t.frameCanvas&&t.mainCanvas){t.frameCanvas.width=t.imageBitmap.width,t.frameCanvas.height=t.imageBitmap.height,t.mainCanvas.width=t.imageBitmap.width,t.mainCanvas.height=t.imageBitmap.height,t.frameContext.drawImage(t.imageBitmap,0,0);const{validBlocks:a,blockHeight:i,blockWidth:n}=E(t.frameContext.getImageData(0,0,t.mainCanvas.width,t.mainCanvas.height),t.appProps.particleRadius);t.validBlocks=a,t.blockHeight=i,t.blockWidth=n,P=A({dimensions:{width:t.mainCanvas.width,height:t.mainCanvas.height},emitterX:t.appProps.emitterX,emitterY:t.appProps.emitterY,emitterSize:t.appProps.emitterSize,emitterAngle:t.appProps.emitterAngle}),t.frameContext.clearRect(0,0,t.frameCanvas.width,t.frameCanvas.height);const r=t.frameCanvas.transferToImageBitmap();t.mainContext.transferFromImageBitmap(r),t.workerParticles=C({validBlocks:t.validBlocks,radius:t.appProps.particleRadius,blockHeight:t.blockHeight,blockWidth:t.blockWidth,startPosition:t.appProps.startPosition,delay:t.appProps.delay,animationDuration:t.appProps.animationDuration})}},pt=e=>{const{appProps:a,shouldUpdateStartCoordinatesConfig:i,shouldRegenerateImageBlocks:n}=e;if(Object.assign(t.appProps,a),n){t.frameContext.drawImage(t.imageBitmap,0,0);const{validBlocks:r,blockHeight:c,blockWidth:m}=E(t.frameContext.getImageData(0,0,t.mainCanvas.width,t.mainCanvas.height),t.appProps.particleRadius);t.validBlocks=r,t.blockHeight=c,t.blockWidth=m}if(i&&(P=A({dimensions:{width:t.mainCanvas.width,height:t.mainCanvas.height},emitterX:t.appProps.emitterX,emitterY:t.appProps.emitterY,emitterSize:t.appProps.emitterSize,emitterAngle:t.appProps.emitterAngle})),t.workerParticles=C({validBlocks:t.validBlocks??new Uint8Array,radius:t.appProps.particleRadius,blockHeight:t.blockHeight,blockWidth:t.blockWidth,startPosition:t.appProps.startPosition,delay:t.appProps.delay,animationDuration:t.appProps.animationDuration}),self.postMessage({type:I.UPDATE_APP_PROPS,data:t.appProps}),t.animationFrameId){cancelAnimationFrame(t.animationFrameId);const r=performance.now();x(r,r)}};self.onmessage=e=>{const{payload:a,type:i}=e.data;switch(i){case f.INITIALIZE:{et(a);break}case f.PLAY:{st();break}case f.RESET:{ct();break}case f.UPDATE_APP_PROPS:{pt(a);break}case f.UPDATE_BITMAP:{lt(a);break}}}})();
