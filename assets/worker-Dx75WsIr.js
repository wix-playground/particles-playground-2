...
Particles!`,R="#ffffff",W=["#ff0000","#00ff00","#0000ff"],$="left-to-right",z={fontFamily:"Arial",fontSize:64,italic:!1,weight:600},j=`// This function will be called twice for each particle, because all particles reach the target in two frames.
...
}`,nt=()=>Object.assign({},{[b]:{code:`${f}${V}`},DEV_TWO_FRAMES:{code:`${f}${j}`},bezier:{code:`${f}${tt}`},pulseColorCycle:{code:`${f}${et}`},timeDistortion:{code:`${f}${at}`},elasticPlop:{code:`${f}${it}`}},...J.map(({name:e,comment:a,definition:r})=>({[e]:{code:`${f}return (particle, animationStartTime, currentTime, canvasDimensions, animationDuration) => {
...
};`}}))),A=(e,a)=>{const{width:i,height:n,data:c}=e,u=Math.ceil(i/a),s=Math.ceil(n/a),o=new Uint8Array(Math.ceil(i/a)*Math.ceil(n/a));let p=0;for(let l=0;l<n;l+=a)for(let m=0;m<i;m+=a){let h=!1;for(let d=0;d<a&&!h;d++)for(let g=0;g<a&&!h;g++){const T=m+g,P=l+d;if(T<i&&P<n){const E=(P*i+T)*4;c[E+3]>10&&(h=!0)}}o[p++]=h?1:0}return{validBlocks:o,blockWidth:u,blockHeight:s}},y=(e,a,r)=>e+r*(a-e),rt=e=>{e=e.replace(/^#/,"");const a=parseInt(e,16),r=a>>16&255,i=a>>8&255,n=a&255;return{r,g:i,b:n}},ot=e=>{const a=e.match(/hsl\((\d+),\s*(\d+)%,\s*(\d+)%\)/);if(!a)return console.warn("Invalid HSL color format:",e),{r:0,g:0,b:0};const r=parseInt(a[1])/360,i=parseInt(a[2])/100,n=parseInt(a[3])/100,c=(p,l,m)=>(m<0&&(m+=1),m>1&&(m-=1),m<1/6?p+(l-p)*6*m:m<1/2?l:m<2/3?p+(l-p)*(2/3-m)*6:p);let u,s,o;if(i===0)u=s=o=n;else{const p=n<.5?n*(1+i):n+i-n*i,l=2*n-p;u=c(l,p,r+1/3),s=c(l,p,r),o=c(l,p,r-1/3)}return{r:Math.round(u*255),g:Math.round(s*255),b:Math.round(o*255)}},Y=e=>e.startsWith("hsl(")?ot(e):rt(e),st=(e,a,r)=>"#"+((1<<24)+(e<<16)+(a<<8)+r).toString(16).slice(1),X=(e,a)=>{if(!(e!=null&&e.length))return"#ffffff";if(e.length===1)return e[0];const i=Math.max(0,Math.min(1,a))*(e.length-1),n=Math.floor(i);if(n===e.length-1)return e[e.length-1];const c=i-n,u=Y(e[n]),s=Y(e[n+1]),o=Math.round(y(u.r,s.r,c)),p=Math.round(y(u.g,s.g,c)),l=Math.round(y(u.b,s.b,c));return st(o,p,l)},C=({dimensions:{width:e,height:a},emitterX:r=e/2,emitterY:i=a/2,emitterSize:n=100,emitterAngle:c=0})=>({top:()=>({x:Math.random()*e,y:0}),center:()=>({x:Math.round(e/2),y:Math.round(a/2)}),bottom:()=>({x:Math.random()*e,y:a}),random:()=>({x:Math.random()*e,y:Math.random()*a}),left:()=>({x:0,y:Math.random()*a}),right:()=>({x:e,y:Math.random()*a}),"top-left":()=>({x:Math.random()*(e/5),y:Math.random()*(a/5)}),"top-right":()=>({x:e,y:Math.random()*(a/5)}),"bottom-left":()=>({x:Math.random()*(e/5),y:a-Math.random()*(a/5)}),"bottom-right":()=>({x:e-Math.random()*(e/5),y:a-Math.random()*(a/5)}),canvasEdges:()=>{const s=Math.floor(Math.random()*4);return s===0?{x:Math.random()*e,y:0}:s===1?{x:Math.random()*e,y:a}:s===2?{x:0,y:Math.random()*a}:{x:e,y:Math.random()*a}},topLeft:()=>({x:0,y:0}),emitterPoint:()=>({x:r,y:i}),emitterCircle:()=>{const s=Math.random()*2*Math.PI,o=Math.random()*n;return{x:r+o*Math.cos(s),y:i+o*Math.sin(s)}},emitterSquare:()=>({x:r+(Math.random()-.5)*n,y:i+(Math.random()-.5)*n}),emitterHLine:()=>{const s=c*(Math.PI/180),o=(Math.random()-.5)*n;return{x:r+o*Math.cos(s),y:i+o*Math.sin(s)}},emitterVLine:()=>{const s=(c+90)*(Math.PI/180),o=(Math.random()-.5)*n;return{x:r+o*Math.cos(s),y:i+o*Math.sin(s)}},enterTopTextWidth:()=>({x:e*.2+Math.random()*e*.6,y:a*.3}),enterBottomTextWidth:()=>({x:e*.2+Math.random()*e*.6,y:a*.7}),enterLeftTextHeight:()=>({x:e*.2,y:a*.3+Math.random()*a*.4}),enterRightTextHeight:()=>({x:e*.8,y:a*.3+Math.random()*a*.4})});let L;const w={particleRadius:5,startPosition:q,selectedMovementFunction:b,movementFunctionCode:nt()[b].code,text:H,font:z,particleColors:W,animationDuration:3e3,particleSpread:3,startParticleOpacity:1,endParticleOpacity:1,startParticleSize:5,endParticleSize:1,particleSizeEasing:B,particleOpacityEasing:N,delay:0,emitterX:Z,emitterY:Q,emitterSize:K,emitterAngle:G,enableRevealAnimation:!1,revealDirection:$},t={workerParticles:[],imageBitmap:null,animationFrameId:0,frameCanvas:null,frameContext:null,mainCanvas:null,mainContext:null,validBlocks:null,blockHeight:0,blockWidth:0,appProps:w,revealProgress:0,effectParticles:[]};let v;const ct=async e=>{t.mainCanvas=e,t.mainContext=t.mainCanvas.getContext("bitmaprenderer"),t.frameCanvas=new OffscreenCanvas(t.mainCanvas.width,t.mainCanvas.height),t.frameContext=t.frameCanvas.getContext("2d",{willReadFrequently:!0})},lt=e=>{const{imageBitmap:a,canvas:r,dimensions:i,appProps:n}=e;t.imageBitmap=a,Object.keys(n).length&&(t.appProps={...w,...n}),ct(r),t.frameContext.drawImage(t.imageBitmap,0,0);const{validBlocks:c,blockHeight:u,blockWidth:s}=A(t.frameContext.getImageData(0,0,t.mainCanvas.width,t.mainCanvas.height),t.appProps.particleRadius);t.validBlocks=c,t.blockHeight=u,t.blockWidth=s,v=C({dimensions:i,emitterX:t.appProps.emitterX,emitterY:t.appProps.emitterY,emitterSize:t.appProps.emitterSize,emitterAngle:t.appProps.emitterAngle}),t.workerParticles=x({validBlocks:t.validBlocks,radius:t.appProps.particleRadius,blockHeight:t.blockHeight,blockWidth:t.blockWidth,startPosition:t.appProps.startPosition,delay:t.appProps.delay,animationDuration:t.appProps.animationDuration,revealAnimation:t.appProps.enableRevealAnimation}),self.postMessage({type:M.INITIALIZED,data:t.appProps})},x=({validBlocks:e,radius:a,blockHeight:r,blockWidth:i,startPosition:n,delay:c,animationDuration:u,revealAnimation:s})=>{const o=[];for(let p=0;p<r;p++)for(let l=0;l<i;l++){const m=p*i+l;if(e[m]){const h=l*a,d=p*a,{x:g,y:T}=s?{x:h,y:d}:v[n](),P=s?0:Math.random()*c,E=u-P;o.push({targetX:h,targetY:d,x:g,y:T,initialX:g,initialY:T,scale:1,opacity:1,color:R,revealProgress:0,revealThreshold:.97+Math.random()*.02,reachedTarget:!1,emittedBubbles:!1,delay:P,lifetime:E,radius:a})}}return o},pt=e=>{if(e.length===0)return{width:0,height:0,minX:0,minY:0,maxX:0,maxY:0};let a=1/0,r=1/0,i=-1/0,n=-1/0;return e.forEach(c=>{a=Math.min(a,c.targetX),r=Math.min(r,c.targetY),i=Math.max(i,c.targetX+t.appProps.particleRadius),n=Math.max(n,c.targetY+t.appProps.particleRadius)}),{minX:a,minY:r,maxX:i,maxY:n,width:i-a,height:n-r}},mt=(e,a,r,i)=>{switch(r){case"left-to-right":{const n=i.minX+a*i.width;return e.targetX<=n}case"right-to-left":{const n=i.maxX-a*i.width;return e.targetX>=n}case"top-to-bottom":{const n=i.minY+a*i.height;return e.targetY<=n}case"bottom-to-top":{const n=i.maxY-a*i.height;return e.targetY>=n}default:return!0}},ut=(e,a)=>{if(a>(e.revealThreshold||.99))return 1;if(a>.85&&Math.sqrt(Math.pow(e.x-e.targetX,2)+Math.pow(e.y-e.targetY,2))<=5){const n=(e.revealThreshold||.99)-.02,c=Math.max(0,(a-n)/.02);return Math.min(1,c)}return 0},k=e=>{const a=t.appProps.startParticleOpacity,r=t.appProps.endParticleOpacity,i=dt(e,t.appProps.particleOpacityEasing);if(t.appProps.particleOpacityEasing!=="linear"){const n=Math.min(a,r),c=Math.max(a,r);return n+(c-n)*i}return a+(r-a)*i},dt=(e,a)=>{switch(a){case"bell":return Math.sin(e*Math.PI);case"linear":return e;case"multiPulse":const i=e*5%1;return Math.sin(i*Math.PI);default:return 1}},ht=(e,a)=>{switch(a){case"bell":return Math.sin(e*Math.PI);case"linear":return e;case"multiPulse":const i=e*5%1;return Math.sin(i*Math.PI);default:return 1}},F=e=>{const a=t.appProps.startParticleSize,r=t.appProps.endParticleSize,i=ht(e,t.appProps.particleSizeEasing);if(t.appProps.particleSizeEasing!=="linear"){const n=Math.min(a,r),c=Math.max(a,r);return n+(c-n)*i}return a+(r-a)*i},_=(e,a,r=!0)=>{const i=k(a),n=F(a),c=e.radius*n,u=t.appProps.particleColors.length?X(t.appProps.particleColors,a):e.color,s=r?Math.floor(e.x)+c/2:Math.floor(e.x),o=r?Math.floor(e.y)+c/2:Math.floor(e.y);t.frameContext.globalAlpha=i,t.frameContext.beginPath(),t.frameContext.arc(s,o,c/2,0,2*Math.PI),t.frameContext.fillStyle=u,t.frameContext.fill()},U=(e,a,r)=>{t.frameContext.clearRect(0,0,t.frameCanvas.width,t.frameCanvas.height);const i=a-e,n=t.appProps.animationDuration-O;t.revealProgress=Math.min(1,i/t.appProps.animationDuration);const c=Math.min(1,i/n);t.frameContext.globalAlpha=1,t.workerParticles.forEach((s,o)=>{if(mt(s,c,t.appProps.revealDirection,r)){if(!s.emittedBubbles&&(s.emittedBubbles=!0,o%2===0)){const l=3+Math.floor(Math.random()*3);for(let m=0;m<l;m++){let h=0,d=0;const g=.5+Math.random()*1;switch(t.appProps.revealDirection){case"left-to-right":h=g,d=0;break;case"right-to-left":h=-g,d=0;break;case"top-to-bottom":h=0,d=g;break;case"bottom-to-top":h=0,d=-g;break}const T=.8,P=h+(Math.random()-.5)*T,E=d+(Math.random()-.5)*T;t.effectParticles.push({x:s.x+t.appProps.particleRadius/2,y:s.y+t.appProps.particleRadius/2,vx:P,vy:E,startTime:a,lifetime:S+Math.random()*(O-S),radius:t.appProps.particleRadius*(.3+Math.random()*.4),opacity:1,color:t.appProps.particleColors.length?X(t.appProps.particleColors,Math.random()):R})}}t.frameContext.drawImage(t.imageBitmap,s.targetX,s.targetY,t.appProps.particleRadius,t.appProps.particleRadius,Math.floor(s.x),Math.floor(s.y),t.appProps.particleRadius,t.appProps.particleRadius)}});for(let s=t.effectParticles.length-1;s>=0;s--){const o=t.effectParticles[s],p=a-o.startTime,l=Math.min(1,p/o.lifetime);if(l>=1){t.effectParticles.splice(s,1);continue}o.x+=o.vx,o.y+=o.vy,o.vx*=.99,o.vy*=.99,_(o,l,!1)}t.frameContext.globalAlpha=1;const u=t.frameCanvas.transferToImageBitmap();if(t.mainContext.transferFromImageBitmap(u),t.revealProgress<1)t.animationFrameId=requestAnimationFrame(s=>U(e,s,r));else{t.frameContext.drawImage(t.imageBitmap,0,0);const s=t.frameCanvas.transferToImageBitmap();t.mainContext.transferFromImageBitmap(s),t.effectParticles=[],t.workerParticles.forEach(o=>{o.emittedBubbles=!1}),self.postMessage({type:M.ANIMATION_COMPLETE})}},D=(e,a)=>{let r=!0;t.frameContext.clearRect(0,0,t.frameCanvas.width,t.frameCanvas.height);const i=a-e;t.revealProgress=Math.min(1,i/t.appProps.animationDuration),t.frameContext.globalAlpha=1,t.workerParticles.forEach(o=>{if(o.delay>a-e)return;const p=i-o.delay,l=Math.max(0,Math.min(1,p/o.lifetime));L(o,e,a,{width:t.mainCanvas.width,height:t.mainCanvas.height},t.appProps.animationDuration);const m=ut(o,t.revealProgress),h=k(l),d=F(l);m>0&&m<1?(_(o,l,!0),t.frameContext.globalAlpha=m*h,t.frameContext.drawImage(t.imageBitmap,o.targetX,o.targetY,d,d,Math.floor(o.x),Math.floor(o.y),d,d)):m>=1?(t.frameContext.globalAlpha=1,t.frameContext.drawImage(t.imageBitmap,o.targetX,o.targetY,t.appProps.particleRadius,t.appProps.particleRadius,Math.floor(o.x),Math.floor(o.y),t.appProps.particleRadius,t.appProps.particleRadius)):_(o,l,!0),(o.x!==o.targetX||o.y!==o.targetY||t.revealProgress<.99)&&(r=!1)});const n=t.frameCanvas.transferToImageBitmap();t.mainContext.transferFromImageBitmap(n);const c=r&&t.revealProgress>=1,u=t.appProps.animationDuration;c&&i>=u?t.animationFrameId&&(cancelAnimationFrame(t.animationFrameId),t.frameContext.drawImage(t.imageBitmap,0,0),self.postMessage({type:M.ANIMATION_COMPLETE})):t.animationFrameId=requestAnimationFrame(o=>D(e,o))},gt=()=>{t.animationFrameId&&cancelAnimationFrame(t.animationFrameId),t.effectParticles=[],L=new Function(t.appProps.movementFunctionCode)();const e=performance.now();if(t.revealProgress=0,t.appProps.enableRevealAnimation){const a=pt(t.workerParticles);t.frameContext.globalAlpha=1,U(e,e,a)}else D(e,e)},ft=()=>{t.animationFrameId&&cancelAnimationFrame(t.animationFrameId),t.effectParticles=[],t.workerParticles=t.workerParticles.map(a=>{const r=v[t.appProps.startPosition](),i=Math.random()*t.appProps.delay,n=t.appProps.animationDuration-i;return{x:r.x,y:r.y,initialX:r.x,initialY:r.y,targetX:a.targetX,targetY:a.targetY,scale:1,opacity:1,color:a.color,revealProgress:0,revealThreshold:a.revealThreshold,reachedTarget:!1,emittedBubbles:!1,delay:i,lifetime:n,radius:t.appProps.particleRadius}}),t.frameContext.clearRect(0,0,t.frameCanvas.width,t.frameCanvas.height);const e=t.frameCanvas.transferToImageBitmap();t.mainContext.transferFromImageBitmap(e),t.animationFrameId&&cancelAnimationFrame(t.animationFrameId)},Tt=e=>{if(t.imageBitmap=e,t.frameCanvas&&t.mainCanvas){t.frameCanvas.width=t.imageBitmap.width,t.frameCanvas.height=t.imageBitmap.height,t.mainCanvas.width=t.imageBitmap.width,t.mainCanvas.height=t.imageBitmap.height,t.frameContext.drawImage(t.imageBitmap,0,0);const{validBlocks:a,blockHeight:r,blockWidth:i}=A(t.frameContext.getImageData(0,0,t.mainCanvas.width,t.mainCanvas.height),t.appProps.particleRadius);t.validBlocks=a,t.blockHeight=r,t.blockWidth=i,v=C({dimensions:{width:t.mainCanvas.width,height:t.mainCanvas.height},emitterX:t.appProps.emitterX,emitterY:t.appProps.emitterY,emitterSize:t.appProps.emitterSize,emitterAngle:t.appProps.emitterAngle}),t.frameContext.clearRect(0,0,t.frameCanvas.width,t.frameCanvas.height);const n=t.frameCanvas.transferToImageBitmap();t.mainContext.transferFromImageBitmap(n),t.workerParticles=x({validBlocks:t.validBlocks,radius:t.appProps.particleRadius,blockHeight:t.blockHeight,blockWidth:t.blockWidth,startPosition:t.appProps.startPosition,delay:t.appProps.delay,animationDuration:t.appProps.animationDuration,revealAnimation:t.appProps.enableRevealAnimation})}},Pt=e=>{const{appProps:a,shouldUpdateStartCoordinatesConfig:r,shouldRegenerateImageBlocks:i}=e;if(Object.assign(t.appProps,a),i){t.frameContext.drawImage(t.imageBitmap,0,0);const{validBlocks:n,blockHeight:c,blockWidth:u}=A(t.frameContext.getImageData(0,0,t.mainCanvas.width,t.mainCanvas.height),t.appProps.particleRadius);t.validBlocks=n,t.blockHeight=c,t.blockWidth=u}if(r&&(v=C({dimensions:{width:t.mainCanvas.width,height:t.mainCanvas.height},emitterX:t.appProps.emitterX,emitterY:t.appProps.emitterY,emitterSize:t.appProps.emitterSize,emitterAngle:t.appProps.emitterAngle})),t.workerParticles=x({validBlocks:t.validBlocks??new Uint8Array,radius:t.appProps.particleRadius,blockHeight:t.blockHeight,blockWidth:t.blockWidth,startPosition:t.appProps.startPosition,delay:t.appProps.delay,animationDuration:t.appProps.animationDuration,revealAnimation:t.appProps.enableRevealAnimation}),self.postMessage({type:M.UPDATE_APP_PROPS,data:t.appProps}),t.animationFrameId){cancelAnimationFrame(t.animationFrameId);const n=performance.now();D(n,n)}};self.onmessage=e=>{const{payload:a,type:r}=e.data;switch(r){case I.INITIALIZE:{lt(a);break}case I.PLAY:{gt();break}case I.RESET:{ft();break}case I.UPDATE_APP_PROPS:{Pt(a);break}case I.UPDATE_BITMAP:{Tt(a);break}}}})();
