(function(){"use strict";const Y="random",y="backInOut",w=`WIX 🤠
Particles!`,X="#ffffff",R=["#ff0000","#00ff00","#0000ff"],k={fontFamily:"Arial",fontSize:64,italic:!1,weight:600,letterSpacing:0,lineHeight:1.2},L=`// This function will be called twice for each particle, because all particles reach the target in two frames.
...
}`,$=()=>Object.assign({},{[y]:{code:`${T}${F}`},DEV_TWO_FRAMES:{code:`${T}${L}`},bezier:{code:`${T}${B}`},pulseColorCycle:{code:`${T}${N}`},timeDistortion:{code:`${T}${q}`},elasticPlop:{code:`${T}${H}`}},...U.map(({name:e,comment:a,definition:i})=>({[e]:{code:`${T}return (particle, animationStartTime, currentTime, canvasDimensions, animationDuration) => {
...
};`}}))),M=(e,a)=>{const{width:r,height:o,data:c}=e,p=Math.ceil(r/a),m=Math.ceil(o/a),n=new Uint8Array(Math.ceil(r/a)*Math.ceil(o/a));let d=0;for(let h=0;h<o;h+=a)for(let u=0;u<r;u+=a){let g=!1;for(let l=0;l<a&&!g;l++)for(let s=0;s<a&&!g;s++){const v=u+s,b=h+l;if(v<r&&b<o){const et=(b*r+v)*4;c[et+3]>10&&(g=!0)}}n[d++]=g?1:0}return{validBlocks:n,blockWidth:p,blockHeight:m}},E=(e,a,i)=>e+i*(a-e),x=e=>{e=e.replace(/^#/,"");const a=parseInt(e,16),i=a>>16&255,r=a>>8&255,o=a&255;return{r:i,g:r,b:o}},W=(e,a,i)=>"#"+((1<<24)+(e<<16)+(a<<8)+i).toString(16).slice(1),D=(e,a)=>{if(!(e!=null&&e.length))return"#ffffff";if(e.length===1)return e[0];const r=Math.max(0,Math.min(1,a))*(e.length-1),o=Math.floor(r);if(o===e.length-1)return e[e.length-1];const c=r-o,p=x(e[o]),m=x(e[o+1]),n=Math.round(E(p.r,m.r,c)),d=Math.round(E(p.g,m.g,c)),h=Math.round(E(p.b,m.b,c));return W(n,d,h)},_=({dimensions:{width:e,height:a}})=>({top:()=>({x:Math.random()*e,y:0}),center:()=>({x:Math.round(e/2),y:Math.round(a/2)}),bottom:()=>({x:Math.random()*e,y:a}),random:()=>({x:Math.random()*e,y:Math.random()*a}),left:()=>({x:0,y:Math.random()*a}),right:()=>({x:e,y:Math.random()*a}),"top-left":()=>({x:Math.random()*(e/5),y:Math.random()*(a/5)}),"top-right":()=>({x:e,y:Math.random()*(a/5)}),"bottom-left":()=>({x:Math.random()*(e/5),y:a-Math.random()*(a/5)}),"bottom-right":()=>({x:e-Math.random()*(e/5),y:a-Math.random()*(a/5)})});let S;const O={particleRadius:5,startPosition:Y,selectedMovementFunction:y,movementFunctionCode:$()[y].code,text:w,font:k,particleColors:R,animationDuration:3e3,particleSpread:3,startParticleOpacity:1,endParticleOpacity:1,startParticleSize:5,endParticleSize:1,delay:0},t={workerParticles:[],imageBitmap:null,animationFrameId:0,frameCanvas:null,frameContext:null,mainCanvas:null,mainContext:null,validBlocks:null,blockHeight:0,blockWidth:0,appProps:O,revealProgress:0};let P;const j=async e=>{t.mainCanvas=e,t.mainContext=t.mainCanvas.getContext("bitmaprenderer"),t.frameCanvas=new OffscreenCanvas(t.mainCanvas.width,t.mainCanvas.height),t.frameContext=t.frameCanvas.getContext("2d",{willReadFrequently:!0})},Z=e=>{const{imageBitmap:a,canvas:i,dimensions:r,appProps:o}=e;t.imageBitmap=a,Object.keys(o).length&&(t.appProps={...O,...o}),j(i),t.frameContext.drawImage(t.imageBitmap,0,0);const{validBlocks:c,blockHeight:p,blockWidth:m}=M(t.frameContext.getImageData(0,0,t.mainCanvas.width,t.mainCanvas.height),t.appProps.particleRadius);t.validBlocks=c,t.blockHeight=p,t.blockWidth=m,P=_({dimensions:r}),t.workerParticles=A({validBlocks:t.validBlocks,radius:t.appProps.particleRadius,blockHeight:t.blockHeight,blockWidth:t.blockWidth,startPosition:t.appProps.startPosition,delay:t.appProps.delay,animationDuration:t.appProps.animationDuration}),self.postMessage({type:I.INITIALIZED,data:t.appProps})},A=({validBlocks:e,radius:a,blockHeight:i,blockWidth:r,startPosition:o,delay:c,animationDuration:p})=>{const m=[];for(let n=0;n<i;n++)for(let d=0;d<r;d++){const h=n*r+d;if(e[h]){const u=d*a,g=n*a,{x:l,y:s}=P[o](),v=Math.random()*c,b=p-v;m.push({targetX:u,targetY:g,x:l,y:s,initialX:l,initialY:s,scale:1,opacity:1,color:X,revealProgress:0,revealThreshold:.97+Math.random()*.02,reachedTarget:!1,emittedBubbles:!1,delay:v,lifetime:b})}}return m},z=(e,a)=>{if(a>(e.revealThreshold||.99))return 1;if(a>.85&&Math.sqrt(Math.pow(e.x-e.targetX,2)+Math.pow(e.y-e.targetY,2))<=5){const o=(e.revealThreshold||.99)-.02,c=Math.max(0,(a-o)/.02);return Math.min(1,c)}return 0},Q=e=>{const a=t.appProps.startParticleOpacity,i=t.appProps.endParticleOpacity;return a+(i-a)*e},V=e=>{const a=t.appProps.startParticleSize,i=t.appProps.endParticleSize;return a+(i-a)*e},C=(e,a)=>{let i=!0;t.frameContext.clearRect(0,0,t.frameCanvas.width,t.frameCanvas.height);const r=a-e;t.revealProgress=Math.min(1,r/t.appProps.animationDuration),t.frameContext.globalAlpha=1,t.workerParticles.forEach(n=>{if(n.delay>a-e)return;const d=r-n.delay,h=Math.max(0,Math.min(1,d/n.lifetime));S(n,e,a,{width:t.mainCanvas.width,height:t.mainCanvas.height},t.appProps.animationDuration);const u=z(n,t.revealProgress),g=Q(h),l=V(h);if(u>0&&u<1){const s=t.appProps.particleRadius*(l||1);t.frameContext.globalAlpha=g*(1-u),t.frameContext.beginPath(),t.frameContext.arc(Math.floor(n.x)+s/2,Math.floor(n.y)+s/2,s/2,0,2*Math.PI),t.frameContext.fillStyle=t.appProps.particleColors.length?D(t.appProps.particleColors,t.revealProgress):n.color,t.frameContext.fill(),t.frameContext.globalAlpha=u*g,t.frameContext.drawImage(t.imageBitmap,n.targetX,n.targetY,l,l,Math.floor(n.x),Math.floor(n.y),l,l)}else if(u>=1)t.frameContext.globalAlpha=1,t.frameContext.drawImage(t.imageBitmap,n.targetX,n.targetY,t.appProps.particleRadius,t.appProps.particleRadius,Math.floor(n.x),Math.floor(n.y),t.appProps.particleRadius,t.appProps.particleRadius);else{const s=t.appProps.particleRadius*(l||1);t.frameContext.globalAlpha=g,t.frameContext.beginPath(),t.frameContext.arc(Math.floor(n.x)+s/2,Math.floor(n.y)+s/2,s/2,0,2*Math.PI),t.frameContext.fillStyle=t.appProps.particleColors.length?D(t.appProps.particleColors,t.revealProgress):n.color,t.frameContext.fill()}(n.x!==n.targetX||n.y!==n.targetY||t.revealProgress<.99)&&(i=!1)});const o=t.frameCanvas.transferToImageBitmap();t.mainContext.transferFromImageBitmap(o);const c=i&&t.revealProgress>=1,p=t.appProps.animationDuration;c&&r>=p?t.animationFrameId&&(cancelAnimationFrame(t.animationFrameId),t.frameContext.drawImage(t.imageBitmap,0,0),self.postMessage({type:I.ANIMATION_COMPLETE})):t.animationFrameId=requestAnimationFrame(n=>C(e,n))},K=()=>{t.animationFrameId&&cancelAnimationFrame(t.animationFrameId),S=new Function(t.appProps.movementFunctionCode)();const e=performance.now();t.revealProgress=0,C(e,e)},G=()=>{t.animationFrameId&&cancelAnimationFrame(t.animationFrameId),t.workerParticles=t.workerParticles.map(a=>{const i=P[t.appProps.startPosition](),r=Math.random()*t.appProps.delay,o=t.appProps.animationDuration-r;return{x:i.x,y:i.y,initialX:i.x,initialY:i.y,targetX:a.targetX,targetY:a.targetY,scale:1,opacity:1,color:a.color,revealProgress:0,revealThreshold:a.revealThreshold,delay:r,lifetime:o}}),t.frameContext.clearRect(0,0,t.frameCanvas.width,t.frameCanvas.height);const e=t.frameCanvas.transferToImageBitmap();t.mainContext.transferFromImageBitmap(e),t.animationFrameId&&cancelAnimationFrame(t.animationFrameId)},J=e=>{if(t.imageBitmap=e,t.frameCanvas&&t.mainCanvas){t.frameCanvas.width=t.imageBitmap.width,t.frameCanvas.height=t.imageBitmap.height,t.mainCanvas.width=t.imageBitmap.width,t.mainCanvas.height=t.imageBitmap.height,t.frameContext.drawImage(t.imageBitmap,0,0);const{validBlocks:a,blockHeight:i,blockWidth:r}=M(t.frameContext.getImageData(0,0,t.mainCanvas.width,t.mainCanvas.height),t.appProps.particleRadius);t.validBlocks=a,t.blockHeight=i,t.blockWidth=r,P=_({dimensions:{width:t.mainCanvas.width,height:t.mainCanvas.height}}),t.frameContext.clearRect(0,0,t.frameCanvas.width,t.frameCanvas.height);const o=t.frameCanvas.transferToImageBitmap();t.mainContext.transferFromImageBitmap(o),t.workerParticles=A({validBlocks:t.validBlocks,radius:t.appProps.particleRadius,blockHeight:t.blockHeight,blockWidth:t.blockWidth,startPosition:t.appProps.startPosition,delay:t.appProps.delay,animationDuration:t.appProps.animationDuration})}},tt=e=>{const{appProps:a}=e;if(Object.assign(t.appProps,a),a.particleRadius!==void 0){t.frameContext.drawImage(t.imageBitmap,0,0);const{validBlocks:i,blockHeight:r,blockWidth:o}=M(t.frameContext.getImageData(0,0,t.mainCanvas.width,t.mainCanvas.height),t.appProps.particleRadius);t.validBlocks=i,t.blockHeight=r,t.blockWidth=o}if(a.startPosition!==void 0&&t.workerParticles.length&&t.workerParticles.forEach(i=>{const r=P[t.appProps.startPosition]();i.initialX=r.x,i.initialY=r.y,i.x=r.x,i.y=r.y}),a.delay!==void 0&&(t.workerParticles=A({validBlocks:t.validBlocks??new Uint8Array,radius:t.appProps.particleRadius,blockHeight:t.blockHeight,blockWidth:t.blockWidth,startPosition:t.appProps.startPosition,delay:t.appProps.delay,animationDuration:t.appProps.animationDuration})),self.postMessage({type:I.UPDATE_APP_PROPS,data:t.appProps}),t.animationFrameId){cancelAnimationFrame(t.animationFrameId);const i=performance.now();C(i,i)}};self.onmessage=e=>{const{payload:a,type:i}=e.data;switch(i){case f.INITIALIZE:{Z(a);break}case f.PLAY:{K();break}case f.RESET:{G();break}case f.UPDATE_APP_PROPS:{tt(a);break}case f.UPDATE_BITMAP:{J(a);break}}}})();
