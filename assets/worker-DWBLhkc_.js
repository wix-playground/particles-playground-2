(function(){"use strict";const B="linear",N="linear",q="random",y="backInOut",H=`WIX 🤠
...
}`,rt=()=>Object.assign({},{[y]:{code:`${g}${V}`},DEV_TWO_FRAMES:{code:`${g}${j}`},bezier:{code:`${g}${tt}`},pulseColorCycle:{code:`${g}${et}`},timeDistortion:{code:`${g}${at}`},elasticPlop:{code:`${g}${it}`}},...J.map(({name:e,comment:a,definition:i})=>({[e]:{code:`${g}return (particle, animationStartTime, currentTime, canvasDimensions, animationDuration) => {
