(function(){"use strict";const M="random",g="DEV_EXAMPLE",O="WIX 🤠",_={fontFamily:"Arial",fontSize:90,italic:!0,weight:400,letterSpacing:0},A=`// This function will be called twice for each particle, because all particles reach the target in two frames.
...
};`,F=()=>Object.assign({},{[g]:{code:y},DEV_TWO_FRAMES:{code:A},bezier:{code:R}},...D.map(({name:e,comment:a,definition:o})=>({[e]:{code:`return (particle, animationStartTime, currentTime, canvasDimensions) => {
