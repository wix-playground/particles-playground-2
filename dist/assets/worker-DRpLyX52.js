(function(){"use strict";const R="random",b="DEV_EXAMPLE",Y=`WIX 🤠
Particles!`,k="#ffffff",X=["#ff0000","#00ff00","#0000ff"],U={fontFamily:"Arial",fontSize:64,italic:!1,weight:600,letterSpacing:0,lineHeight:1.2},F=`// This function will be called twice for each particle, because all particles reach the target in two frames.
...
}`,W=()=>Object.assign({},{[b]:{code:`${P}${B}`},DEV_TWO_FRAMES:{code:`${P}${F}`},bezier:{code:`${P}${N}`},pulseColorCycle:{code:`${P}${q}`},timeDistortion:{code:`${P}${H}`},elasticPlop:{code:`${P}${$}`}},...L.map(({name:e,comment:a,definition:c})=>({[e]:{code:`${P}return (particle, animationStartTime, currentTime, canvasDimensions, animationDuration) => {
...
};`}}))),v=(e,a)=>{const{width:r,height:n,data:o}=e,l=Math.ceil(r/a),u=Math.ceil(n/a),i=new Uint8Array(Math.ceil(r/a)*Math.ceil(n/a));let s=0;for(let d=0;d<n;d+=a)for(let p=0;p<r;p+=a){let g=!1;for(let E=0;E<a&&!g;E++)for(let A=0;A<a&&!g;A++){const S=p+A,w=d+E;if(S<r&&w<n){const J=(w*r+S)*4;o[J+3]>10&&(g=!0)}}i[s++]=g?1:0}return{validBlocks:i,blockWidth:l,blockHeight:u}},I=(e,a,c)=>e+c*(a-e),x=e=>{e=e.replace(/^#/,"");const a=parseInt(e,16),c=a>>16&255,r=a>>8&255,n=a&255;return{r:c,g:r,b:n}},j=(e,a,c)=>"#"+((1<<24)+(e<<16)+(a<<8)+c).toString(16).slice(1),M=(e,a)=>{if(!(e!=null&&e.length))return"#ffffff";if(e.length===1)return e[0];const r=Math.max(0,Math.min(1,a))*(e.length-1),n=Math.floor(r);if(n===e.length-1)return e[e.length-1];const o=r-n,l=x(e[n]),u=x(e[n+1]),i=Math.round(I(l.r,u.r,o)),s=Math.round(I(l.g,u.g,o)),d=Math.round(I(l.b,u.b,o));return j(i,s,d)},_=({dimensions:{width:e,height:a}})=>({top:()=>({x:Math.random()*e,y:0}),center:()=>({x:Math.round(e/2),y:Math.round(a/2)}),bottom:()=>({x:Math.random()*e,y:a}),random:()=>({x:Math.random()*e,y:Math.random()*a}),left:()=>({x:0,y:Math.random()*a}),right:()=>({x:e,y:Math.random()*a}),"top-left":()=>({x:Math.random()*(e/5),y:Math.random()*(a/5)}),"top-right":()=>({x:e,y:Math.random()*(a/5)}),"bottom-left":()=>({x:Math.random()*(e/5),y:a-Math.random()*(a/5)}),"bottom-right":()=>({x:e-Math.random()*(e/5),y:a-Math.random()*(a/5)})});let D;const O={particleRadius:5,startPosition:R,selectedMovementFunction:b,movementFunctionCode:W()[b].code,text:Y,font:U,particleColors:X,animationDuration:3e3,enableBubbles:!1,particleSpread:3,startParticleOpacity:1,endParticleOpacity:1},t={workerParticles:[],bubbleParticles:[],imageBitmap:null,animationFrameId:0,frameCanvas:null,frameContext:null,mainCanvas:null,mainContext:null,validBlocks:null,blockHeight:0,blockWidth:0,appProps:O,revealProgress:0};let T;const Q=async e=>{t.mainCanvas=e,t.mainContext=t.mainCanvas.getContext("bitmaprenderer"),t.frameCanvas=new OffscreenCanvas(t.mainCanvas.width,t.mainCanvas.height),t.frameContext=t.frameCanvas.getContext("2d",{willReadFrequently:!0})},V=e=>{const{imageBitmap:a,canvas:c,dimensions:r,appProps:n}=e;t.imageBitmap=a,Object.keys(n).length&&(t.appProps={...O,...n}),Q(c),t.frameContext.drawImage(t.imageBitmap,0,0);const{validBlocks:o,blockHeight:l,blockWidth:u}=v(t.frameContext.getImageData(0,0,t.mainCanvas.width,t.mainCanvas.height),t.appProps.particleRadius);t.validBlocks=o,t.blockHeight=l,t.blockWidth=u,T=_({dimensions:r}),t.workerParticles=y({validBlocks:t.validBlocks,radius:t.appProps.particleRadius,blockHeight:t.blockHeight,blockWidth:t.blockWidth,startPosition:t.appProps.startPosition})},Z=(e,a,c,r,n=5)=>{const o=[];for(let l=0;l<n;l++){const u=Math.random()*Math.PI*2,i=.5+Math.random()*2;o.push({x:e,y:a,dx:Math.cos(u)*i,dy:Math.sin(u)*i-1,radius:2+Math.random()*5,color:c,opacity:.7+Math.random()*.3,createdAt:r,lifetime:C})}return o},y=({validBlocks:e,radius:a,blockHeight:c,blockWidth:r,startPosition:n})=>{const o=[];for(let l=0;l<c;l++)for(let u=0;u<r;u++){const i=l*r+u;if(e[i]){const s=u*a,d=l*a,{x:p,y:g}=T[n]();o.push({targetX:s,targetY:d,x:p,y:g,initialX:p,initialY:g,scale:1,opacity:1,color:k,revealProgress:0,revealThreshold:.97+Math.random()*.02,reachedTarget:!1,emittedBubbles:!1})}}return o},z=(e,a)=>{if(a>(e.revealThreshold||.99))return 1;if(a>.85&&Math.sqrt(Math.pow(e.x-e.targetX,2)+Math.pow(e.y-e.targetY,2))<=5){const n=(e.revealThreshold||.99)-.02,o=Math.max(0,(a-n)/.02);return Math.min(1,o)}return 0},K=e=>{const a=t.appProps.startParticleOpacity,c=t.appProps.endParticleOpacity;return a+(c-a)*e},f=(e,a)=>{let c=!0;t.frameContext.clearRect(0,0,t.frameCanvas.width,t.frameCanvas.height);const r=a-e;t.revealProgress=Math.min(1,r/t.appProps.animationDuration);for(let i=t.bubbleParticles.length-1;i>=0;i--){const s=t.bubbleParticles[i];s.x+=s.dx,s.y+=s.dy,s.dx+=(Math.random()-.5)*.1,s.dy-=.02;const d=a-s.createdAt,p=Math.min(1,d/s.lifetime),g=s.opacity*(1-p);t.frameContext.beginPath(),t.frameContext.arc(Math.floor(s.x),Math.floor(s.y),s.radius,0,Math.PI*2),t.frameContext.fillStyle=M(t.appProps.particleColors,p),t.frameContext.globalAlpha=g,t.frameContext.fill(),d>=s.lifetime&&t.bubbleParticles.splice(i,1)}t.frameContext.globalAlpha=1,t.workerParticles.forEach(i=>{D(i,e,a,{width:t.mainCanvas.width,height:t.mainCanvas.height},t.appProps.animationDuration);const s=z(i,t.revealProgress),d=K(t.revealProgress);if(s>0&&s<1){const p=Math.floor(t.appProps.particleRadius*(i.scale||1));t.frameContext.globalAlpha=d*(1-s),t.frameContext.beginPath(),t.frameContext.arc(Math.floor(i.x)+p/2,Math.floor(i.y)+p/2,p/2,0,2*Math.PI),t.frameContext.fillStyle=t.appProps.particleColors.length?M(t.appProps.particleColors,t.revealProgress):i.color,t.frameContext.fill(),t.frameContext.globalAlpha=s*d,t.frameContext.drawImage(t.imageBitmap,i.targetX,i.targetY,t.appProps.particleRadius,t.appProps.particleRadius,Math.floor(i.x),Math.floor(i.y),t.appProps.particleRadius,t.appProps.particleRadius)}else if(s>=1)t.frameContext.globalAlpha=d,t.frameContext.drawImage(t.imageBitmap,i.targetX,i.targetY,t.appProps.particleRadius,t.appProps.particleRadius,Math.floor(i.x),Math.floor(i.y),t.appProps.particleRadius,t.appProps.particleRadius);else{const p=Math.floor(t.appProps.particleRadius*(i.scale||1));t.frameContext.globalAlpha=d,t.frameContext.beginPath(),t.frameContext.arc(Math.floor(i.x)+p/2,Math.floor(i.y)+p/2,p/2,0,2*Math.PI),t.frameContext.fillStyle=t.appProps.particleColors.length?M(t.appProps.particleColors,t.revealProgress):i.color,t.frameContext.fill()}if(!i.emittedBubbles&&t.appProps.enableBubbles&&i.x===i.targetX&&i.y===i.targetY){i.emittedBubbles=!0;const p=Z(i.x,i.y,i.color,a,2+Math.floor(Math.random()*3));t.bubbleParticles.push(...p)}(i.x!==i.targetX||i.y!==i.targetY||t.revealProgress<.99)&&(c=!1)});const n=t.frameCanvas.transferToImageBitmap();t.mainContext.transferFromImageBitmap(n);const o=c&&t.revealProgress>=1,l=t.appProps.animationDuration+(t.appProps.enableBubbles?C:0);o&&r>=l?t.animationFrameId&&(cancelAnimationFrame(t.animationFrameId),t.bubbleParticles=[],t.frameContext.drawImage(t.imageBitmap,0,0),self.postMessage({type:h.ANIMATION_COMPLETE})):t.animationFrameId=requestAnimationFrame(i=>f(e,i))},G=()=>{D=new Function(t.appProps.movementFunctionCode)();const e=performance.now();t.revealProgress=0,t.bubbleParticles=[],t.workerParticles.forEach(a=>{a.emittedBubbles=!1}),f(e,e)};self.onmessage=e=>{const{payload:a,type:c}=e.data;switch(c){case m.INITIALIZE:{V(a),console.log("worker initializing"),self.postMessage({type:h.INITIALIZED,data:t.appProps});break}case m.PLAY:{t.animationFrameId&&cancelAnimationFrame(t.animationFrameId),t.bubbleParticles=[],G();break}case m.RESET:{t.animationFrameId&&cancelAnimationFrame(t.animationFrameId),t.workerParticles=t.workerParticles.map(n=>{const o=T[t.appProps.startPosition]();return{x:o.x,y:o.y,initialX:o.x,initialY:o.y,targetX:n.targetX,targetY:n.targetY,scale:1,opacity:1,color:n.color,revealProgress:0,revealThreshold:n.revealThreshold}}),t.frameContext.clearRect(0,0,t.frameCanvas.width,t.frameCanvas.height);const r=t.frameCanvas.transferToImageBitmap();t.mainContext.transferFromImageBitmap(r),t.animationFrameId&&cancelAnimationFrame(t.animationFrameId);break}case m.RESIZE_PARTICLE_RADIUS:{t.appProps.particleRadius=a,t.frameContext.drawImage(t.imageBitmap,0,0);const{validBlocks:r,blockHeight:n,blockWidth:o}=v(t.frameContext.getImageData(0,0,t.mainCanvas.width,t.mainCanvas.height),t.appProps.particleRadius);if(t.validBlocks=r,t.blockHeight=n,t.blockWidth=o,t.workerParticles=y({validBlocks:t.validBlocks,radius:t.appProps.particleRadius,blockHeight:t.blockHeight,blockWidth:t.blockWidth,startPosition:t.appProps.startPosition}),self.postMessage({type:h.UPDATE_APP_PROPS,data:t.appProps}),t.animationFrameId){cancelAnimationFrame(t.animationFrameId);const l=performance.now();f(l,l)}break}case m.UPDATE_START_POSITION:{if(t.appProps.startPosition=a,t.workerParticles.length){if(t.workerParticles.forEach(r=>{const n=T[t.appProps.startPosition]();r.initialX=n.x,r.initialY=n.y,r.x=n.x,r.y=n.y}),self.postMessage({type:h.UPDATE_APP_PROPS,data:t.appProps}),t.animationFrameId){cancelAnimationFrame(t.animationFrameId);const r=performance.now();f(r,r)}}else console.error("updateStartPosition failed, particles were not initialized",{workerParticles:t.workerParticles});break}case m.UPDATE_SELECTED_MOVEMENT_FUNCTION:{const{key:r,movementFunctionCode:n}=a??{};r&&(t.appProps.selectedMovementFunction=r),n!=null&&(t.appProps.movementFunctionCode=n),self.postMessage({type:h.UPDATE_APP_PROPS,data:t.appProps});break}case m.UPDATE_TEXT:{t.appProps.text=a,self.postMessage({type:h.UPDATE_APP_PROPS,data:t.appProps});break}case m.UPDATE_FONT:{t.appProps.font=a,self.postMessage({type:h.UPDATE_APP_PROPS,data:t.appProps});break}case m.UPDATE_PARTICLE_COLORS:{if(t.appProps.particleColors=a,a.length>0,self.postMessage({type:h.UPDATE_APP_PROPS,data:t.appProps}),t.animationFrameId){cancelAnimationFrame(t.animationFrameId);const r=performance.now();f(r,r)}break}case m.UPDATE_BITMAP:{if(t.imageBitmap=a,t.frameCanvas&&t.mainCanvas){t.frameCanvas.width=t.imageBitmap.width,t.frameCanvas.height=t.imageBitmap.height,t.mainCanvas.width=t.imageBitmap.width,t.mainCanvas.height=t.imageBitmap.height,t.frameContext.drawImage(t.imageBitmap,0,0);const{validBlocks:r,blockHeight:n,blockWidth:o}=v(t.frameContext.getImageData(0,0,t.mainCanvas.width,t.mainCanvas.height),t.appProps.particleRadius);t.validBlocks=r,t.blockHeight=n,t.blockWidth=o,T=_({dimensions:{width:t.mainCanvas.width,height:t.mainCanvas.height}}),t.frameContext.clearRect(0,0,t.frameCanvas.width,t.frameCanvas.height);const l=t.frameCanvas.transferToImageBitmap();t.mainContext.transferFromImageBitmap(l),t.workerParticles=y({validBlocks:t.validBlocks,radius:t.appProps.particleRadius,blockHeight:t.blockHeight,blockWidth:t.blockWidth,startPosition:t.appProps.startPosition})}break}case m.UPDATE_ANIMATION_DURATION:{t.appProps.animationDuration=a,self.postMessage({type:h.UPDATE_APP_PROPS,data:t.appProps}),t.animationFrameId&&(t.bubbleParticles=[]);break}case m.UPDATE_ENABLE_BUBBLES:{t.appProps.enableBubbles=a,self.postMessage({type:h.UPDATE_APP_PROPS,data:t.appProps});break}case m.UPDATE_PARTICLE_SPREAD:{t.appProps.particleSpread=a,self.postMessage({type:h.UPDATE_APP_PROPS,data:t.appProps});break}case m.UPDATE_START_PARTICLE_OPACITY:{if(t.appProps.startParticleOpacity=a,self.postMessage({type:h.UPDATE_APP_PROPS,data:t.appProps}),t.animationFrameId){cancelAnimationFrame(t.animationFrameId);const r=performance.now();f(r,r)}break}case m.UPDATE_END_PARTICLE_OPACITY:{if(t.appProps.endParticleOpacity=a,self.postMessage({type:h.UPDATE_APP_PROPS,data:t.appProps}),t.animationFrameId){cancelAnimationFrame(t.animationFrameId);const r=performance.now();f(r,r)}break}}}})();
