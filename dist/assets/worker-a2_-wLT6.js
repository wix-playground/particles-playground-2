(function(){"use strict";const X="random",b="DEV_EXAMPLE",k="WIX 🤠",Y="#ffffff",B=["#ff0000","#00ff00","#0000ff"],R={fontFamily:"Arial",fontSize:90,italic:!1,weight:400,letterSpacing:0},F=`// This function will be called twice for each particle, because all particles reach the target in two frames.
