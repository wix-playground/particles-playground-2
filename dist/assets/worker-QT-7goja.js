(function(){"use strict";const w="random",b="DEV_EXAMPLE",D="WIX 🤠",M="#ffffff",R=["#ff0000","#00ff00","#0000ff"],S={fontFamily:"Arial",fontSize:90,italic:!0,weight:400,letterSpacing:0},F=`// This function will be called twice for each particle, because all particles reach the target in two frames.
...
}`,Y=()=>Object.assign({},{[b]:{code:`${T}${U}`},DEV_TWO_FRAMES:{code:`${T}${F}`},bezier:{code:`${T}${L}`},pulseColorCycle:{code:`${T}${X}`}},...B.map(({name:a,comment:n,definition:o})=>({[a]:{code:`${T}return (particle, animationStartTime, currentTime, canvasDimensions) => {
