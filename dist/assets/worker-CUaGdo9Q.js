(function(){"use strict";const R="random",b="backInOut",w=`WIX 🤠
Particles!`,Y="#ffffff",k=["#ff0000","#00ff00","#0000ff"],U={fontFamily:"Arial",fontSize:64,italic:!1,weight:600,letterSpacing:0,lineHeight:1.2},F=`// This function will be called twice for each particle, because all particles reach the target in two frames.
...
return (particle, animationStartTime, currentTime, canvasDimensions, animationDuration) => {
  ...
  t < 0.5
    ...
    */`},{name:"elasticIn",definition:` const elasticIn = (x) => {
    ...
    }`,comment:""}],B=`return (particle, animationStartTime, currentTime, canvasDimensions, animationDuration) => {
    const totalElapsedTime = currentTime - animationStartTime;
...
`,N=`return (particle, animationStartTime, currentTime, canvasDimensions, animationDuration) => {
...
}`,W=()=>Object.assign({},{[b]:{code:`${I}${X}`},DEV_TWO_FRAMES:{code:`${I}${F}`},bezier:{code:`${I}${B}`},pulseColorCycle:{code:`${I}${N}`},timeDistortion:{code:`${I}${q}`},elasticPlop:{code:`${I}${H}`}},...L.map(({name:e,comment:a,definition:i})=>({[e]:{code:`${I}return (particle, animationStartTime, currentTime, canvasDimensions, animationDuration) => {
...
};`}}))),M=(e,a)=>{const{width:r,height:o,data:p}=e,d=Math.ceil(r/a),u=Math.ceil(o/a),n=new Uint8Array(Math.ceil(r/a)*Math.ceil(o/a));let g=0;for(let P=0;P<o;P+=a)for(let h=0;h<r;h+=a){let T=!1;for(let m=0;m<a&&!T;m++)for(let l=0;l<a&&!T;l++){const A=h+l,y=P+m;if(A<r&&y<o){const dt=(y*r+A)*4;p[dt+3]>10&&(T=!0)}}n[g++]=T?1:0}return{validBlocks:n,blockWidth:d,blockHeight:u}},C=(e,a,i)=>e+i*(a-e),D=e=>{e=e.replace(/^#/,"");const a=parseInt(e,16),i=a>>16&255,r=a>>8&255,o=a&255;return{r:i,g:r,b:o}},$=(e,a,i)=>"#"+((1<<24)+(e<<16)+(a<<8)+i).toString(16).slice(1),_=(e,a)=>{if(!(e!=null&&e.length))return"#ffffff";if(e.length===1)return e[0];const r=Math.max(0,Math.min(1,a))*(e.length-1),o=Math.floor(r);if(o===e.length-1)return e[e.length-1];const p=r-o,d=D(e[o]),u=D(e[o+1]),n=Math.round(C(d.r,u.r,p)),g=Math.round(C(d.g,u.g,p)),P=Math.round(C(d.b,u.b,p));return $(n,g,P)},x=({dimensions:{width:e,height:a}})=>({top:()=>({x:Math.random()*e,y:0}),center:()=>({x:Math.round(e/2),y:Math.round(a/2)}),bottom:()=>({x:Math.random()*e,y:a}),random:()=>({x:Math.random()*e,y:Math.random()*a}),left:()=>({x:0,y:Math.random()*a}),right:()=>({x:e,y:Math.random()*a}),"top-left":()=>({x:Math.random()*(e/5),y:Math.random()*(a/5)}),"top-right":()=>({x:e,y:Math.random()*(a/5)}),"bottom-left":()=>({x:Math.random()*(e/5),y:a-Math.random()*(a/5)}),"bottom-right":()=>({x:e-Math.random()*(e/5),y:a-Math.random()*(a/5)})});let S;const O={particleRadius:5,startPosition:R,selectedMovementFunction:b,movementFunctionCode:W()[b].code,text:w,font:U,particleColors:k,animationDuration:3e3,particleSpread:3,startParticleOpacity:1,endParticleOpacity:1,startParticleSize:5,endParticleSize:1,delay:0},t={workerParticles:[],imageBitmap:null,animationFrameId:0,frameCanvas:null,frameContext:null,mainCanvas:null,mainContext:null,validBlocks:null,blockHeight:0,blockWidth:0,appProps:O,revealProgress:0};let v;const Z=async e=>{t.mainCanvas=e,t.mainContext=t.mainCanvas.getContext("bitmaprenderer"),t.frameCanvas=new OffscreenCanvas(t.mainCanvas.width,t.mainCanvas.height),t.frameContext=t.frameCanvas.getContext("2d",{willReadFrequently:!0})},j=e=>{const{imageBitmap:a,canvas:i,dimensions:r,appProps:o}=e;t.imageBitmap=a,Object.keys(o).length&&(t.appProps={...O,...o}),Z(i),t.frameContext.drawImage(t.imageBitmap,0,0);const{validBlocks:p,blockHeight:d,blockWidth:u}=M(t.frameContext.getImageData(0,0,t.mainCanvas.width,t.mainCanvas.height),t.appProps.particleRadius);t.validBlocks=p,t.blockHeight=d,t.blockWidth=u,v=x({dimensions:r}),t.workerParticles=E({validBlocks:t.validBlocks,radius:t.appProps.particleRadius,blockHeight:t.blockHeight,blockWidth:t.blockWidth,startPosition:t.appProps.startPosition,delay:t.appProps.delay,animationDuration:t.appProps.animationDuration}),self.postMessage({type:c.INITIALIZED,data:t.appProps})},E=({validBlocks:e,radius:a,blockHeight:i,blockWidth:r,startPosition:o,delay:p,animationDuration:d})=>{const u=[];for(let n=0;n<i;n++)for(let g=0;g<r;g++){const P=n*r+g;if(e[P]){const h=g*a,T=n*a,{x:m,y:l}=v[o](),A=Math.random()*p,y=d-A;u.push({targetX:h,targetY:T,x:m,y:l,initialX:m,initialY:l,scale:1,opacity:1,color:Y,revealProgress:0,revealThreshold:.97+Math.random()*.02,reachedTarget:!1,emittedBubbles:!1,delay:A,lifetime:y})}}return u},z=(e,a)=>{if(a>(e.revealThreshold||.99))return 1;if(a>.85&&Math.sqrt(Math.pow(e.x-e.targetX,2)+Math.pow(e.y-e.targetY,2))<=5){const o=(e.revealThreshold||.99)-.02,p=Math.max(0,(a-o)/.02);return Math.min(1,p)}return 0},Q=e=>{const a=t.appProps.startParticleOpacity,i=t.appProps.endParticleOpacity;return a+(i-a)*e},V=e=>{const a=t.appProps.startParticleSize,i=t.appProps.endParticleSize;return a+(i-a)*e},f=(e,a)=>{let i=!0;t.frameContext.clearRect(0,0,t.frameCanvas.width,t.frameCanvas.height);const r=a-e;t.revealProgress=Math.min(1,r/t.appProps.animationDuration),t.frameContext.globalAlpha=1,t.workerParticles.forEach(n=>{if(n.delay>a-e)return;const g=r-n.delay,P=Math.max(0,Math.min(1,g/n.lifetime));S(n,e,a,{width:t.mainCanvas.width,height:t.mainCanvas.height},t.appProps.animationDuration);const h=z(n,t.revealProgress),T=Q(P),m=V(P);if(h>0&&h<1){const l=t.appProps.particleRadius*(m||1);t.frameContext.globalAlpha=T*(1-h),t.frameContext.beginPath(),t.frameContext.arc(Math.floor(n.x)+l/2,Math.floor(n.y)+l/2,l/2,0,2*Math.PI),t.frameContext.fillStyle=t.appProps.particleColors.length?_(t.appProps.particleColors,t.revealProgress):n.color,t.frameContext.fill(),t.frameContext.globalAlpha=h*T,t.frameContext.drawImage(t.imageBitmap,n.targetX,n.targetY,m,m,Math.floor(n.x),Math.floor(n.y),m,m)}else if(h>=1)t.frameContext.globalAlpha=1,t.frameContext.drawImage(t.imageBitmap,n.targetX,n.targetY,t.appProps.particleRadius,t.appProps.particleRadius,Math.floor(n.x),Math.floor(n.y),t.appProps.particleRadius,t.appProps.particleRadius);else{const l=t.appProps.particleRadius*(m||1);t.frameContext.globalAlpha=T,t.frameContext.beginPath(),t.frameContext.arc(Math.floor(n.x)+l/2,Math.floor(n.y)+l/2,l/2,0,2*Math.PI),t.frameContext.fillStyle=t.appProps.particleColors.length?_(t.appProps.particleColors,t.revealProgress):n.color,t.frameContext.fill()}(n.x!==n.targetX||n.y!==n.targetY||t.revealProgress<.99)&&(i=!1)});const o=t.frameCanvas.transferToImageBitmap();t.mainContext.transferFromImageBitmap(o);const p=i&&t.revealProgress>=1,d=t.appProps.animationDuration;p&&r>=d?t.animationFrameId&&(cancelAnimationFrame(t.animationFrameId),t.frameContext.drawImage(t.imageBitmap,0,0),self.postMessage({type:c.ANIMATION_COMPLETE})):t.animationFrameId=requestAnimationFrame(n=>f(e,n))},K=()=>{t.animationFrameId&&cancelAnimationFrame(t.animationFrameId),S=new Function(t.appProps.movementFunctionCode)();const e=performance.now();t.revealProgress=0,f(e,e)},G=()=>{t.animationFrameId&&cancelAnimationFrame(t.animationFrameId),t.workerParticles=t.workerParticles.map(a=>{const i=v[t.appProps.startPosition](),r=Math.random()*t.appProps.delay,o=t.appProps.animationDuration-r;return{x:i.x,y:i.y,initialX:i.x,initialY:i.y,targetX:a.targetX,targetY:a.targetY,scale:1,opacity:1,color:a.color,revealProgress:0,revealThreshold:a.revealThreshold,delay:r,lifetime:o}}),t.frameContext.clearRect(0,0,t.frameCanvas.width,t.frameCanvas.height);const e=t.frameCanvas.transferToImageBitmap();t.mainContext.transferFromImageBitmap(e),t.animationFrameId&&cancelAnimationFrame(t.animationFrameId)},J=e=>{t.appProps.particleRadius=e,t.frameContext.drawImage(t.imageBitmap,0,0);const{validBlocks:a,blockHeight:i,blockWidth:r}=M(t.frameContext.getImageData(0,0,t.mainCanvas.width,t.mainCanvas.height),t.appProps.particleRadius);if(t.validBlocks=a,t.blockHeight=i,t.blockWidth=r,t.workerParticles=E({validBlocks:t.validBlocks,radius:t.appProps.particleRadius,blockHeight:t.blockHeight,blockWidth:t.blockWidth,startPosition:t.appProps.startPosition,delay:t.appProps.delay,animationDuration:t.appProps.animationDuration}),self.postMessage({type:c.UPDATE_APP_PROPS,data:t.appProps}),t.animationFrameId){cancelAnimationFrame(t.animationFrameId);const o=performance.now();f(o,o)}},tt=e=>{if(t.appProps.startPosition=e,t.workerParticles.length){if(t.workerParticles.forEach(a=>{const i=v[t.appProps.startPosition]();a.initialX=i.x,a.initialY=i.y,a.x=i.x,a.y=i.y}),self.postMessage({type:c.UPDATE_APP_PROPS,data:t.appProps}),t.animationFrameId){cancelAnimationFrame(t.animationFrameId);const a=performance.now();f(a,a)}}else console.error("updateStartPosition failed, particles were not initialized",{workerParticles:t.workerParticles})},et=e=>{const{key:a,movementFunctionCode:i}=e??{};a&&(t.appProps.selectedMovementFunction=a),i!=null&&(t.appProps.movementFunctionCode=i),self.postMessage({type:c.UPDATE_APP_PROPS,data:t.appProps})},at=e=>{t.appProps.font=e,self.postMessage({type:c.UPDATE_APP_PROPS,data:t.appProps})},it=e=>{if(t.appProps.particleColors=e,e.length>0,self.postMessage({type:c.UPDATE_APP_PROPS,data:t.appProps}),t.animationFrameId){cancelAnimationFrame(t.animationFrameId);const a=performance.now();f(a,a)}},nt=e=>{if(t.imageBitmap=e,t.frameCanvas&&t.mainCanvas){t.frameCanvas.width=t.imageBitmap.width,t.frameCanvas.height=t.imageBitmap.height,t.mainCanvas.width=t.imageBitmap.width,t.mainCanvas.height=t.imageBitmap.height,t.frameContext.drawImage(t.imageBitmap,0,0);const{validBlocks:a,blockHeight:i,blockWidth:r}=M(t.frameContext.getImageData(0,0,t.mainCanvas.width,t.mainCanvas.height),t.appProps.particleRadius);t.validBlocks=a,t.blockHeight=i,t.blockWidth=r,v=x({dimensions:{width:t.mainCanvas.width,height:t.mainCanvas.height}}),t.frameContext.clearRect(0,0,t.frameCanvas.width,t.frameCanvas.height);const o=t.frameCanvas.transferToImageBitmap();t.mainContext.transferFromImageBitmap(o),t.workerParticles=E({validBlocks:t.validBlocks,radius:t.appProps.particleRadius,blockHeight:t.blockHeight,blockWidth:t.blockWidth,startPosition:t.appProps.startPosition,delay:t.appProps.delay,animationDuration:t.appProps.animationDuration})}},rt=e=>{t.appProps.animationDuration=e,self.postMessage({type:c.UPDATE_APP_PROPS,data:t.appProps})},ot=e=>{t.appProps.particleSpread=e,self.postMessage({type:c.UPDATE_APP_PROPS,data:t.appProps})},st=e=>{t.appProps.delay=e,t.workerParticles=E({validBlocks:t.validBlocks??new Uint8Array,radius:t.appProps.particleRadius,blockHeight:t.blockHeight,blockWidth:t.blockWidth,startPosition:t.appProps.startPosition,delay:t.appProps.delay,animationDuration:t.appProps.animationDuration}),self.postMessage({type:c.UPDATE_APP_PROPS,data:t.appProps})},ct=e=>{if(t.appProps.startParticleOpacity=e,self.postMessage({type:c.UPDATE_APP_PROPS,data:t.appProps}),t.animationFrameId){cancelAnimationFrame(t.animationFrameId);const a=performance.now();f(a,a)}},lt=e=>{if(t.appProps.endParticleOpacity=e,self.postMessage({type:c.UPDATE_APP_PROPS,data:t.appProps}),t.animationFrameId){cancelAnimationFrame(t.animationFrameId);const a=performance.now();f(a,a)}},pt=e=>{if(t.appProps.startParticleSize=e,self.postMessage({type:c.UPDATE_APP_PROPS,data:t.appProps}),t.animationFrameId){cancelAnimationFrame(t.animationFrameId);const a=performance.now();f(a,a)}},mt=e=>{if(t.appProps.endParticleSize=e,self.postMessage({type:c.UPDATE_APP_PROPS,data:t.appProps}),t.animationFrameId){cancelAnimationFrame(t.animationFrameId);const a=performance.now();f(a,a)}};self.onmessage=e=>{const{payload:a,type:i}=e.data;switch(i){case s.INITIALIZE:{j(a);break}case s.PLAY:{K();break}case s.RESET:{G();break}case s.RESIZE_PARTICLE_RADIUS:{J(a);break}case s.UPDATE_START_POSITION:{tt(a);break}case s.UPDATE_SELECTED_MOVEMENT_FUNCTION:{et(a);break}case s.UPDATE_TEXT:{t.appProps.text=a,self.postMessage({type:c.UPDATE_APP_PROPS,data:t.appProps});break}case s.UPDATE_FONT:{at(a);break}case s.UPDATE_PARTICLE_COLORS:{it(a);break}case s.UPDATE_BITMAP:{nt(a);break}case s.UPDATE_ANIMATION_DURATION:{rt(a);break}case s.UPDATE_PARTICLE_SPREAD:{ot(a);break}case s.UPDATE_DELAY:{st(a);break}case s.UPDATE_START_PARTICLE_OPACITY:{ct(a);break}case s.UPDATE_END_PARTICLE_OPACITY:{lt(a);break}case s.UPDATE_START_PARTICLE_SIZE:{pt(a);break}case s.UPDATE_END_PARTICLE_SIZE:{mt(a);break}}}})();
