(function(){"use strict";const B="random",b="DEV_EXAMPLE",R="WIX 🤠",S="#ffffff",U=["#ff0000","#00ff00","#0000ff"],F={fontFamily:"Arial",fontSize:90,italic:!0,weight:400,letterSpacing:0},X=`// This function will be called twice for each particle, because all particles reach the target in two frames.
...
}`,H=()=>Object.assign({},{[b]:{code:`${g}${Y}`},DEV_TWO_FRAMES:{code:`${g}${X}`},bezier:{code:`${g}${N}`},pulseColorCycle:{code:`${g}${q}`}},...L.map(({name:e,comment:a,definition:c})=>({[e]:{code:`${g}return (particle, animationStartTime, currentTime, canvasDimensions, animationDuration) => {
...
};`}}))),v=(e,a)=>{const{width:i,height:r,data:o}=e,l=Math.ceil(i/a),m=Math.ceil(r/a),n=new Uint8Array(Math.ceil(i/a)*Math.ceil(r/a));let s=0;for(let p=0;p<r;p+=a)for(let h=0;h<i;h+=a){let f=!1;for(let C=0;C<a&&!f;C++)for(let A=0;A<a&&!f;A++){const k=h+A,w=p+C;if(k<i&&w<r){const z=(w*i+k)*4;o[z+3]>10&&(f=!0)}}n[s++]=f?1:0}return{validBlocks:n,blockWidth:l,blockHeight:m}},I=(e,a,c)=>e+c*(a-e),_=e=>{e=e.replace(/^#/,"");const a=parseInt(e,16),c=a>>16&255,i=a>>8&255,r=a&255;return{r:c,g:i,b:r}},W=(e,a,c)=>"#"+((1<<24)+(e<<16)+(a<<8)+c).toString(16).slice(1),M=(e,a)=>{if(!(e!=null&&e.length))return"#ffffff";if(e.length===1)return e[0];const i=Math.max(0,Math.min(1,a))*(e.length-1),r=Math.floor(i);if(r===e.length-1)return e[e.length-1];const o=i-r,l=_(e[r]),m=_(e[r+1]),n=Math.round(I(l.r,m.r,o)),s=Math.round(I(l.g,m.g,o)),p=Math.round(I(l.b,m.b,o));return W(n,s,p)},y=({dimensions:{width:e,height:a}})=>({top:()=>({x:Math.random()*e,y:0}),center:()=>({x:Math.round(e/2),y:Math.round(a/2)}),bottom:()=>({x:Math.random()*e,y:a}),random:()=>({x:Math.random()*e,y:Math.random()*a}),left:()=>({x:0,y:Math.random()*a}),right:()=>({x:e,y:Math.random()*a}),"top-left":()=>({x:Math.random()*(e/5),y:Math.random()*(a/5)}),"top-right":()=>({x:e,y:Math.random()*(a/5)}),"bottom-left":()=>({x:Math.random()*(e/5),y:a-Math.random()*(a/5)}),"bottom-right":()=>({x:e-Math.random()*(e/5),y:a-Math.random()*(a/5)})});let O;const D={particleRadius:5,startPosition:B,selectedMovementFunction:b,movementFunctionCode:H()[b].code,text:R,font:F,particleColors:U,animationDuration:3e3,enableBubbles:!1},t={workerParticles:[],bubbleParticles:[],imageBitmap:null,animationFrameId:0,frameCanvas:null,frameContext:null,mainCanvas:null,mainContext:null,validBlocks:null,blockHeight:0,blockWidth:0,appProps:D,revealProgress:0};let P;const $=async e=>{t.mainCanvas=e,t.mainContext=t.mainCanvas.getContext("bitmaprenderer"),t.frameCanvas=new OffscreenCanvas(t.mainCanvas.width,t.mainCanvas.height),t.frameContext=t.frameCanvas.getContext("2d",{willReadFrequently:!0})},j=e=>{const{imageBitmap:a,canvas:c,dimensions:i,appProps:r}=e;t.imageBitmap=a,Object.keys(r).length&&(t.appProps={...D,...r}),$(c),t.frameContext.drawImage(t.imageBitmap,0,0);const{validBlocks:o,blockHeight:l,blockWidth:m}=v(t.frameContext.getImageData(0,0,t.mainCanvas.width,t.mainCanvas.height),t.appProps.particleRadius);t.validBlocks=o,t.blockHeight=l,t.blockWidth=m,P=y({dimensions:i}),t.workerParticles=E({validBlocks:t.validBlocks,radius:t.appProps.particleRadius,blockHeight:t.blockHeight,blockWidth:t.blockWidth,startPosition:t.appProps.startPosition})},Q=(e,a,c,i,r=5)=>{const o=[];for(let l=0;l<r;l++){const m=Math.random()*Math.PI*2,n=.5+Math.random()*2;o.push({x:e,y:a,dx:Math.cos(m)*n,dy:Math.sin(m)*n-1,radius:2+Math.random()*5,color:c,opacity:.7+Math.random()*.3,createdAt:i,lifetime:x})}return o},E=({validBlocks:e,radius:a,blockHeight:c,blockWidth:i,startPosition:r})=>{const o=[];for(let l=0;l<c;l++)for(let m=0;m<i;m++){const n=l*i+m;if(e[n]){const s=m*a,p=l*a,{x:h,y:f}=P[r]();o.push({targetX:s,targetY:p,x:h,y:f,initialX:h,initialY:f,scale:1,opacity:1,color:S,revealProgress:0,revealThreshold:.97+Math.random()*.02,reachedTarget:!1,emittedBubbles:!1})}}return o},V=(e,a)=>{if(a>(e.revealThreshold||.99))return 1;if(a>.85&&Math.sqrt(Math.pow(e.x-e.targetX,2)+Math.pow(e.y-e.targetY,2))<=5){const r=(e.revealThreshold||.99)-.02,o=Math.max(0,(a-r)/.02);return Math.min(1,o)}return 0},T=(e,a)=>{let c=!0;t.frameContext.clearRect(0,0,t.frameCanvas.width,t.frameCanvas.height);const i=a-e;t.revealProgress=Math.min(1,i/t.appProps.animationDuration);for(let n=t.bubbleParticles.length-1;n>=0;n--){const s=t.bubbleParticles[n];s.x+=s.dx,s.y+=s.dy,s.dx+=(Math.random()-.5)*.1,s.dy-=.02;const p=a-s.createdAt,h=Math.min(1,p/s.lifetime),f=s.opacity*(1-h);t.frameContext.beginPath(),t.frameContext.arc(Math.floor(s.x),Math.floor(s.y),s.radius,0,Math.PI*2),t.frameContext.fillStyle=M(t.appProps.particleColors,h),t.frameContext.globalAlpha=f,t.frameContext.fill(),p>=s.lifetime&&t.bubbleParticles.splice(n,1)}t.frameContext.globalAlpha=1,t.workerParticles.forEach(n=>{O(n,e,a,{width:t.mainCanvas.width,height:t.mainCanvas.height},t.appProps.animationDuration);const s=V(n,t.revealProgress);if(s>0&&s<1){const p=Math.floor(t.appProps.particleRadius*(n.scale||1));t.frameContext.globalAlpha=(n.opacity||1)*(1-s),t.frameContext.beginPath(),t.frameContext.arc(Math.floor(n.x)+p/2,Math.floor(n.y)+p/2,p/2,0,2*Math.PI),t.frameContext.fillStyle=t.appProps.particleColors.length?M(t.appProps.particleColors,t.revealProgress):n.color,t.frameContext.fill(),t.frameContext.globalAlpha=s,t.frameContext.drawImage(t.imageBitmap,n.targetX,n.targetY,t.appProps.particleRadius,t.appProps.particleRadius,Math.floor(n.x),Math.floor(n.y),t.appProps.particleRadius,t.appProps.particleRadius)}else if(s>=1)t.frameContext.globalAlpha=1,t.frameContext.drawImage(t.imageBitmap,n.targetX,n.targetY,t.appProps.particleRadius,t.appProps.particleRadius,Math.floor(n.x),Math.floor(n.y),t.appProps.particleRadius,t.appProps.particleRadius);else{const p=Math.floor(t.appProps.particleRadius*(n.scale||1));t.frameContext.globalAlpha=n.opacity||1,t.frameContext.beginPath(),t.frameContext.arc(Math.floor(n.x)+p/2,Math.floor(n.y)+p/2,p/2,0,2*Math.PI),t.frameContext.fillStyle=t.appProps.particleColors.length?M(t.appProps.particleColors,t.revealProgress):n.color,t.frameContext.fill()}if(!n.emittedBubbles&&t.appProps.enableBubbles&&n.x===n.targetX&&n.y===n.targetY){n.emittedBubbles=!0;const p=Q(n.x,n.y,n.color,a,2+Math.floor(Math.random()*3));t.bubbleParticles.push(...p)}(n.x!==n.targetX||n.y!==n.targetY||t.revealProgress<.99)&&(c=!1)});const r=t.frameCanvas.transferToImageBitmap();t.mainContext.transferFromImageBitmap(r);const o=c&&t.revealProgress>=1,l=t.appProps.animationDuration+(t.appProps.enableBubbles?x:0);o&&i>=l?t.animationFrameId&&(cancelAnimationFrame(t.animationFrameId),t.bubbleParticles=[],t.frameContext.drawImage(t.imageBitmap,0,0)):t.animationFrameId=requestAnimationFrame(n=>T(e,n))},Z=()=>{O=new Function(t.appProps.movementFunctionCode)();const e=performance.now();t.revealProgress=0,t.bubbleParticles=[],t.workerParticles.forEach(a=>{a.emittedBubbles=!1}),T(e,e)};self.onmessage=e=>{const{payload:a,type:c}=e.data;switch(c){case u.INITIALIZE:{j(a),self.postMessage({type:d.INITIALIZED,data:t.appProps});break}case u.PLAY:{t.animationFrameId&&cancelAnimationFrame(t.animationFrameId),t.bubbleParticles=[],Z();break}case u.RESET:{t.animationFrameId&&cancelAnimationFrame(t.animationFrameId),t.workerParticles=t.workerParticles.map(r=>{const o=P[t.appProps.startPosition]();return{x:o.x,y:o.y,initialX:o.x,initialY:o.y,targetX:r.targetX,targetY:r.targetY,scale:1,opacity:1,color:r.color,revealProgress:0,revealThreshold:r.revealThreshold}}),t.frameContext.clearRect(0,0,t.frameCanvas.width,t.frameCanvas.height);const i=t.frameCanvas.transferToImageBitmap();t.mainContext.transferFromImageBitmap(i),t.animationFrameId&&cancelAnimationFrame(t.animationFrameId);break}case u.RESIZE_PARTICLE_RADIUS:{t.appProps.particleRadius=a,t.frameContext.drawImage(t.imageBitmap,0,0);const{validBlocks:i,blockHeight:r,blockWidth:o}=v(t.frameContext.getImageData(0,0,t.mainCanvas.width,t.mainCanvas.height),t.appProps.particleRadius);if(t.validBlocks=i,t.blockHeight=r,t.blockWidth=o,t.workerParticles=E({validBlocks:t.validBlocks,radius:t.appProps.particleRadius,blockHeight:t.blockHeight,blockWidth:t.blockWidth,startPosition:t.appProps.startPosition}),self.postMessage({type:d.UPDATE_APP_PROPS,data:t.appProps}),t.animationFrameId){cancelAnimationFrame(t.animationFrameId);const l=performance.now();T(l,l)}break}case u.UPDATE_START_POSITION:{if(t.appProps.startPosition=a,t.workerParticles.length){if(t.workerParticles.forEach(i=>{const r=P[t.appProps.startPosition]();i.initialX=r.x,i.initialY=r.y,i.x=r.x,i.y=r.y}),self.postMessage({type:d.UPDATE_APP_PROPS,data:t.appProps}),t.animationFrameId){cancelAnimationFrame(t.animationFrameId);const i=performance.now();T(i,i)}}else console.error("updateStartPosition failed, particles were not initialized",{workerParticles:t.workerParticles});break}case u.UPDATE_SELECTED_MOVEMENT_FUNCTION:{const{key:i,movementFunctionCode:r}=a??{};i&&(t.appProps.selectedMovementFunction=i),r!=null&&(t.appProps.movementFunctionCode=r),self.postMessage({type:d.UPDATE_APP_PROPS,data:t.appProps});break}case u.UPDATE_TEXT:{t.appProps.text=a,self.postMessage({type:d.UPDATE_APP_PROPS,data:t.appProps});break}case u.UPDATE_FONT:{t.appProps.font=a,self.postMessage({type:d.UPDATE_APP_PROPS,data:t.appProps});break}case u.UPDATE_PARTICLE_COLORS:{if(t.appProps.particleColors=a,a.length>0,self.postMessage({type:d.UPDATE_APP_PROPS,data:t.appProps}),t.animationFrameId){cancelAnimationFrame(t.animationFrameId);const i=performance.now();T(i,i)}break}case u.UPDATE_BITMAP:{if(t.imageBitmap=a,t.frameCanvas&&t.mainCanvas){t.frameCanvas.width=t.imageBitmap.width,t.frameCanvas.height=t.imageBitmap.height,t.mainCanvas.width=t.imageBitmap.width,t.mainCanvas.height=t.imageBitmap.height,t.frameContext.drawImage(t.imageBitmap,0,0);const{validBlocks:i,blockHeight:r,blockWidth:o}=v(t.frameContext.getImageData(0,0,t.mainCanvas.width,t.mainCanvas.height),t.appProps.particleRadius);t.validBlocks=i,t.blockHeight=r,t.blockWidth=o,P=y({dimensions:{width:t.mainCanvas.width,height:t.mainCanvas.height}}),t.workerParticles=E({validBlocks:t.validBlocks,radius:t.appProps.particleRadius,blockHeight:t.blockHeight,blockWidth:t.blockWidth,startPosition:t.appProps.startPosition})}break}case u.UPDATE_ANIMATION_DURATION:{t.appProps.animationDuration=a,self.postMessage({type:d.UPDATE_APP_PROPS,data:t.appProps}),t.animationFrameId&&(t.bubbleParticles=[]);break}case u.UPDATE_ENABLE_BUBBLES:{t.appProps.enableBubbles=a,self.postMessage({type:d.UPDATE_APP_PROPS,data:t.appProps});break}}}})();
