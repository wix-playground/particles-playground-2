(function(){"use strict";const X="linear",L="linear",w="random",E="backInOut",F=`WIX 🤠
...
}`,J=()=>Object.assign({},{[E]:{code:`${T}${H}`},DEV_TWO_FRAMES:{code:`${T}${q}`},bezier:{code:`${T}${V}`},pulseColorCycle:{code:`${T}${Q}`},timeDistortion:{code:`${T}${K}`},elasticPlop:{code:`${T}${G}`}},...Z.map(({name:e,comment:a,definition:n})=>({[e]:{code:`${T}return (particle, animationStartTime, currentTime, canvasDimensions, animationDuration) => {
...
};`}}))),A=(e,a)=>{const{width:r,height:i,data:s}=e,u=Math.ceil(r/a),c=Math.ceil(i/a),o=new Uint8Array(Math.ceil(r/a)*Math.ceil(i/a));let l=0;for(let p=0;p<i;p+=a)for(let m=0;m<r;m+=a){let g=!1;for(let h=0;h<a&&!g;h++)for(let d=0;d<a&&!g;d++){const v=m+d,M=p+h;if(v<r&&M<i){const _=(M*r+v)*4;s[_+3]>10&&(g=!0)}}o[l++]=g?1:0}return{validBlocks:o,blockWidth:u,blockHeight:c}},b=(e,a,n)=>e+n*(a-e),tt=e=>{e=e.replace(/^#/,"");const a=parseInt(e,16),n=a>>16&255,r=a>>8&255,i=a&255;return{r:n,g:r,b:i}},et=e=>{const a=e.match(/hsl\((\d+),\s*(\d+)%,\s*(\d+)%\)/);if(!a)return console.warn("Invalid HSL color format:",e),{r:0,g:0,b:0};const n=parseInt(a[1])/360,r=parseInt(a[2])/100,i=parseInt(a[3])/100,s=(l,p,m)=>(m<0&&(m+=1),m>1&&(m-=1),m<1/6?l+(p-l)*6*m:m<1/2?p:m<2/3?l+(p-l)*(2/3-m)*6:l);let u,c,o;if(r===0)u=c=o=i;else{const l=i<.5?i*(1+r):i+r-i*r,p=2*i-l;u=s(p,l,n+1/3),c=s(p,l,n),o=s(p,l,n-1/3)}return{r:Math.round(u*255),g:Math.round(c*255),b:Math.round(o*255)}},D=e=>e.startsWith("hsl(")?et(e):tt(e),at=(e,a,n)=>"#"+((1<<24)+(e<<16)+(a<<8)+n).toString(16).slice(1),O=(e,a)=>{if(!(e!=null&&e.length))return"#ffffff";if(e.length===1)return e[0];const r=Math.max(0,Math.min(1,a))*(e.length-1),i=Math.floor(r);if(i===e.length-1)return e[e.length-1];const s=r-i,u=D(e[i]),c=D(e[i+1]),o=Math.round(b(u.r,c.r,s)),l=Math.round(b(u.g,c.g,s)),p=Math.round(b(u.b,c.b,s));return at(o,l,p)},y=({dimensions:{width:e,height:a},emitterX:n=e/2,emitterY:r=a/2,emitterSize:i=100,emitterAngle:s=0})=>({top:()=>({x:Math.random()*e,y:0}),center:()=>({x:Math.round(e/2),y:Math.round(a/2)}),bottom:()=>({x:Math.random()*e,y:a}),random:()=>({x:Math.random()*e,y:Math.random()*a}),left:()=>({x:0,y:Math.random()*a}),right:()=>({x:e,y:Math.random()*a}),"top-left":()=>({x:Math.random()*(e/5),y:Math.random()*(a/5)}),"top-right":()=>({x:e,y:Math.random()*(a/5)}),"bottom-left":()=>({x:Math.random()*(e/5),y:a-Math.random()*(a/5)}),"bottom-right":()=>({x:e-Math.random()*(e/5),y:a-Math.random()*(a/5)}),canvasEdges:()=>{const c=Math.floor(Math.random()*4);return c===0?{x:Math.random()*e,y:0}:c===1?{x:Math.random()*e,y:a}:c===2?{x:0,y:Math.random()*a}:{x:e,y:Math.random()*a}},topLeft:()=>({x:0,y:0}),emitterPoint:()=>({x:n,y:r}),emitterCircle:()=>{const c=Math.random()*2*Math.PI,o=Math.random()*i;return{x:n+o*Math.cos(c),y:r+o*Math.sin(c)}},emitterSquare:()=>({x:n+(Math.random()-.5)*i,y:r+(Math.random()-.5)*i}),emitterHLine:()=>{const c=s*(Math.PI/180),o=(Math.random()-.5)*i;return{x:n+o*Math.cos(c),y:r+o*Math.sin(c)}},emitterVLine:()=>{const c=(s+90)*(Math.PI/180),o=(Math.random()-.5)*i;return{x:n+o*Math.cos(c),y:r+o*Math.sin(c)}},enterTopTextWidth:()=>({x:e*.2+Math.random()*e*.6,y:a*.3}),enterBottomTextWidth:()=>({x:e*.2+Math.random()*e*.6,y:a*.7}),enterLeftTextHeight:()=>({x:e*.2,y:a*.3+Math.random()*a*.4}),enterRightTextHeight:()=>({x:e*.8,y:a*.3+Math.random()*a*.4})});let R;const S={particleRadius:5,startPosition:w,selectedMovementFunction:E,movementFunctionCode:J()[E].code,text:F,font:N,particleColors:k,animationDuration:3e3,particleSpread:3,startParticleOpacity:1,endParticleOpacity:1,startParticleSize:5,endParticleSize:1,particleSizeEasing:X,particleOpacityEasing:L,delay:0,emitterX:W,emitterY:$,emitterSize:z,emitterAngle:j,enableRevealAnimation:!1,revealDirection:B},t={workerParticles:[],imageBitmap:null,animationFrameId:0,frameCanvas:null,frameContext:null,mainCanvas:null,mainContext:null,validBlocks:null,blockHeight:0,blockWidth:0,appProps:S,revealProgress:0};let I;const it=async e=>{t.mainCanvas=e,t.mainContext=t.mainCanvas.getContext("bitmaprenderer"),t.frameCanvas=new OffscreenCanvas(t.mainCanvas.width,t.mainCanvas.height),t.frameContext=t.frameCanvas.getContext("2d",{willReadFrequently:!0})},rt=e=>{const{imageBitmap:a,canvas:n,dimensions:r,appProps:i}=e;t.imageBitmap=a,Object.keys(i).length&&(t.appProps={...S,...i}),it(n),t.frameContext.drawImage(t.imageBitmap,0,0);const{validBlocks:s,blockHeight:u,blockWidth:c}=A(t.frameContext.getImageData(0,0,t.mainCanvas.width,t.mainCanvas.height),t.appProps.particleRadius);t.validBlocks=s,t.blockHeight=u,t.blockWidth=c,I=y({dimensions:r,emitterX:t.appProps.emitterX,emitterY:t.appProps.emitterY,emitterSize:t.appProps.emitterSize,emitterAngle:t.appProps.emitterAngle}),t.workerParticles=C({validBlocks:t.validBlocks,radius:t.appProps.particleRadius,blockHeight:t.blockHeight,blockWidth:t.blockWidth,startPosition:t.appProps.startPosition,delay:t.appProps.delay,animationDuration:t.appProps.animationDuration,revealAnimation:t.appProps.enableRevealAnimation}),self.postMessage({type:P.INITIALIZED,data:t.appProps})},C=({validBlocks:e,radius:a,blockHeight:n,blockWidth:r,startPosition:i,delay:s,animationDuration:u,revealAnimation:c})=>{const o=[];for(let l=0;l<n;l++)for(let p=0;p<r;p++){const m=l*r+p;if(e[m]){const g=p*a,h=l*a,{x:d,y:v}=c?{x:g,y:h}:I[i](),M=Math.random()*s,_=u-M;o.push({targetX:g,targetY:h,x:d,y:v,initialX:d,initialY:v,scale:1,opacity:1,color:U,revealProgress:0,revealThreshold:.97+Math.random()*.02,reachedTarget:!1,emittedBubbles:!1,delay:M,lifetime:_})}}return o},nt=(e,a,n,r)=>{switch(n){case"left-to-right":{const i=a*r.width;return e.targetX<=i}case"right-to-left":{const i=(1-a)*r.width;return e.targetX>=i}case"top-to-bottom":{const i=a*r.height;return e.targetY<=i}case"bottom-to-top":{const i=(1-a)*r.height;return e.targetY>=i}default:return!0}},ot=(e,a)=>{if(a>(e.revealThreshold||.99))return 1;if(a>.85&&Math.sqrt(Math.pow(e.x-e.targetX,2)+Math.pow(e.y-e.targetY,2))<=5){const i=(e.revealThreshold||.99)-.02,s=Math.max(0,(a-i)/.02);return Math.min(1,s)}return 0},st=e=>{const a=t.appProps.startParticleOpacity,n=t.appProps.endParticleOpacity,r=ct(e,t.appProps.particleOpacityEasing);if(t.appProps.particleOpacityEasing!=="linear"){const i=Math.min(a,n),s=Math.max(a,n);return i+(s-i)*r}return a+(n-a)*r},ct=(e,a)=>{switch(a){case"bell":return Math.sin(e*Math.PI);case"linear":return e;case"multiPulse":const r=e*5%1;return Math.sin(r*Math.PI);default:return 1}},lt=(e,a)=>{switch(a){case"bell":return Math.sin(e*Math.PI);case"linear":return e;case"multiPulse":const r=e*5%1;return Math.sin(r*Math.PI);default:return 1}},pt=e=>{const a=t.appProps.startParticleSize,n=t.appProps.endParticleSize,r=lt(e,t.appProps.particleSizeEasing);if(t.appProps.particleSizeEasing!=="linear"){const i=Math.min(a,n),s=Math.max(a,n);return i+(s-i)*r}return a+(n-a)*r},Y=(e,a)=>{t.frameContext.clearRect(0,0,t.frameCanvas.width,t.frameCanvas.height);const n=a-e;t.revealProgress=Math.min(1,n/t.appProps.animationDuration),t.workerParticles.forEach(i=>{nt(i,t.revealProgress,t.appProps.revealDirection,{width:t.mainCanvas.width,height:t.mainCanvas.height})&&t.frameContext.drawImage(t.imageBitmap,i.targetX,i.targetY,t.appProps.particleRadius,t.appProps.particleRadius,Math.floor(i.x),Math.floor(i.y),t.appProps.particleRadius,t.appProps.particleRadius)});const r=t.frameCanvas.transferToImageBitmap();if(t.mainContext.transferFromImageBitmap(r),t.revealProgress<1)t.animationFrameId=requestAnimationFrame(i=>Y(e,i));else{t.frameContext.drawImage(t.imageBitmap,0,0);const i=t.frameCanvas.transferToImageBitmap();t.mainContext.transferFromImageBitmap(i),self.postMessage({type:P.ANIMATION_COMPLETE})}},x=(e,a)=>{let n=!0;t.frameContext.clearRect(0,0,t.frameCanvas.width,t.frameCanvas.height);const r=a-e;t.revealProgress=Math.min(1,r/t.appProps.animationDuration),t.frameContext.globalAlpha=1,t.workerParticles.forEach(o=>{if(o.delay>a-e)return;const l=r-o.delay,p=Math.max(0,Math.min(1,l/o.lifetime));R(o,e,a,{width:t.mainCanvas.width,height:t.mainCanvas.height},t.appProps.animationDuration);const m=ot(o,t.revealProgress),g=st(p),h=pt(p);if(m>0&&m<1){const d=t.appProps.particleRadius*(h||1);t.frameContext.globalAlpha=g*(1-m),t.frameContext.beginPath(),t.frameContext.arc(Math.floor(o.x)+d/2,Math.floor(o.y)+d/2,d/2,0,2*Math.PI),t.frameContext.fillStyle=t.appProps.particleColors.length?O(t.appProps.particleColors,t.revealProgress):o.color,t.frameContext.fill(),t.frameContext.globalAlpha=m*g,t.frameContext.drawImage(t.imageBitmap,o.targetX,o.targetY,h,h,Math.floor(o.x),Math.floor(o.y),h,h)}else if(m>=1)t.frameContext.globalAlpha=1,t.frameContext.drawImage(t.imageBitmap,o.targetX,o.targetY,t.appProps.particleRadius,t.appProps.particleRadius,Math.floor(o.x),Math.floor(o.y),t.appProps.particleRadius,t.appProps.particleRadius);else{const d=t.appProps.particleRadius*(h||1);t.frameContext.globalAlpha=g,t.frameContext.beginPath(),t.frameContext.arc(Math.floor(o.x)+d/2,Math.floor(o.y)+d/2,d/2,0,2*Math.PI),t.frameContext.fillStyle=t.appProps.particleColors.length?O(t.appProps.particleColors,t.revealProgress):o.color,t.frameContext.fill()}(o.x!==o.targetX||o.y!==o.targetY||t.revealProgress<.99)&&(n=!1)});const i=t.frameCanvas.transferToImageBitmap();t.mainContext.transferFromImageBitmap(i);const s=n&&t.revealProgress>=1,u=t.appProps.animationDuration;s&&r>=u?t.animationFrameId&&(cancelAnimationFrame(t.animationFrameId),t.frameContext.drawImage(t.imageBitmap,0,0),self.postMessage({type:P.ANIMATION_COMPLETE})):t.animationFrameId=requestAnimationFrame(o=>x(e,o))},mt=()=>{t.animationFrameId&&cancelAnimationFrame(t.animationFrameId),R=new Function(t.appProps.movementFunctionCode)();const e=performance.now();t.revealProgress=0,t.appProps.enableRevealAnimation?(t.frameContext.globalAlpha=1,Y(e,e)):x(e,e)},ut=()=>{t.animationFrameId&&cancelAnimationFrame(t.animationFrameId),t.workerParticles=t.workerParticles.map(a=>{const n=I[t.appProps.startPosition](),r=Math.random()*t.appProps.delay,i=t.appProps.animationDuration-r;return{x:n.x,y:n.y,initialX:n.x,initialY:n.y,targetX:a.targetX,targetY:a.targetY,scale:1,opacity:1,color:a.color,revealProgress:0,revealThreshold:a.revealThreshold,delay:r,lifetime:i}}),t.frameContext.clearRect(0,0,t.frameCanvas.width,t.frameCanvas.height);const e=t.frameCanvas.transferToImageBitmap();t.mainContext.transferFromImageBitmap(e),t.animationFrameId&&cancelAnimationFrame(t.animationFrameId)},dt=e=>{if(t.imageBitmap=e,t.frameCanvas&&t.mainCanvas){t.frameCanvas.width=t.imageBitmap.width,t.frameCanvas.height=t.imageBitmap.height,t.mainCanvas.width=t.imageBitmap.width,t.mainCanvas.height=t.imageBitmap.height,t.frameContext.drawImage(t.imageBitmap,0,0);const{validBlocks:a,blockHeight:n,blockWidth:r}=A(t.frameContext.getImageData(0,0,t.mainCanvas.width,t.mainCanvas.height),t.appProps.particleRadius);t.validBlocks=a,t.blockHeight=n,t.blockWidth=r,I=y({dimensions:{width:t.mainCanvas.width,height:t.mainCanvas.height},emitterX:t.appProps.emitterX,emitterY:t.appProps.emitterY,emitterSize:t.appProps.emitterSize,emitterAngle:t.appProps.emitterAngle}),t.frameContext.clearRect(0,0,t.frameCanvas.width,t.frameCanvas.height);const i=t.frameCanvas.transferToImageBitmap();t.mainContext.transferFromImageBitmap(i),t.workerParticles=C({validBlocks:t.validBlocks,radius:t.appProps.particleRadius,blockHeight:t.blockHeight,blockWidth:t.blockWidth,startPosition:t.appProps.startPosition,delay:t.appProps.delay,animationDuration:t.appProps.animationDuration,revealAnimation:t.appProps.enableRevealAnimation})}},ht=e=>{const{appProps:a,shouldUpdateStartCoordinatesConfig:n,shouldRegenerateImageBlocks:r}=e;if(Object.assign(t.appProps,a),r){t.frameContext.drawImage(t.imageBitmap,0,0);const{validBlocks:i,blockHeight:s,blockWidth:u}=A(t.frameContext.getImageData(0,0,t.mainCanvas.width,t.mainCanvas.height),t.appProps.particleRadius);t.validBlocks=i,t.blockHeight=s,t.blockWidth=u}if(n&&(I=y({dimensions:{width:t.mainCanvas.width,height:t.mainCanvas.height},emitterX:t.appProps.emitterX,emitterY:t.appProps.emitterY,emitterSize:t.appProps.emitterSize,emitterAngle:t.appProps.emitterAngle})),t.workerParticles=C({validBlocks:t.validBlocks??new Uint8Array,radius:t.appProps.particleRadius,blockHeight:t.blockHeight,blockWidth:t.blockWidth,startPosition:t.appProps.startPosition,delay:t.appProps.delay,animationDuration:t.appProps.animationDuration,revealAnimation:t.appProps.enableRevealAnimation}),self.postMessage({type:P.UPDATE_APP_PROPS,data:t.appProps}),t.animationFrameId){cancelAnimationFrame(t.animationFrameId);const i=performance.now();x(i,i)}};self.onmessage=e=>{const{payload:a,type:n}=e.data;switch(n){case f.INITIALIZE:{rt(a);break}case f.PLAY:{mt();break}case f.RESET:{ut();break}case f.UPDATE_APP_PROPS:{ht(a);break}case f.UPDATE_BITMAP:{dt(a);break}}}})();
