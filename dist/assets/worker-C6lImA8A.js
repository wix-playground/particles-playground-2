...
};`,R=()=>Object.assign({},{[P]:{code:y},DEV_TWO_FRAMES:{code:_},bezier:{code:D}},...A.map(({name:e,comment:n,definition:c})=>({[e]:{code:`return (particle, animationStartTime, currentTime, canvasDimensions) => {
...
};`}}))),v=(e,n)=>{const{width:r,height:a,data:o}=e,i=Math.ceil(r/n),s=Math.ceil(a/n),m=new Uint8Array(Math.ceil(r/n)*Math.ceil(a/n));let f=0;for(let p=0;p<a;p+=n)for(let u=0;u<r;u+=n){let d=!1;for(let b=0;b<n&&!d;b++)for(let x=0;x<n&&!d;x++){const k=u+x,M=p+b;if(k<r&&M<a){const U=(M*r+k)*4;o[U+3]>10&&(d=!0)}}m[f++]=d?1:0}return{validBlocks:m,blockWidth:i,blockHeight:s}},E=({dimensions:{width:e,height:n}})=>({top:()=>({x:Math.random()*e,y:0}),center:()=>({x:Math.round(e/2),y:Math.round(n/2)}),bottom:()=>({x:Math.random()*e,y:n}),random:()=>({x:Math.random()*e,y:Math.random()*n}),left:()=>({x:0,y:Math.random()*n}),right:()=>({x:e,y:Math.random()*n}),"top-left":()=>({x:Math.random()*(e/5),y:Math.random()*(n/5)}),"top-right":()=>({x:e,y:Math.random()*(n/5)}),"bottom-left":()=>({x:Math.random()*(e/5),y:n-Math.random()*(n/5)}),"bottom-right":()=>({x:e-Math.random()*(e/5),y:n-Math.random()*(n/5)})});let C;const t={workerParticles:[],imageBitmap:null,animationFrameId:0,frameCanvas:null,frameContext:null,mainCanvas:null,mainContext:null,validBlocks:null,blockHeight:0,blockWidth:0,appProps:{particleRadius:2,startPosition:w,selectedMovementFunction:P,movementFunctionCode:R()[P].code,text:O}};let T;const B=async e=>{t.mainCanvas=e,t.mainContext=t.mainCanvas.getContext("bitmaprenderer"),t.frameCanvas=new OffscreenCanvas(t.mainCanvas.width,t.mainCanvas.height),t.frameContext=t.frameCanvas.getContext("2d",{willReadFrequently:!0})},F=async e=>{const{imageBitmap:n,canvas:c,dimensions:r,particleRadius:a,movementFunctionCode:o,selectedMovementFunction:i,startPosition:s,text:m}=e;t.imageBitmap=n,o&&i&&a&&s&&m&&(t.appProps.movementFunctionCode=o,t.appProps.selectedMovementFunction=i,t.appProps.particleRadius=a,t.appProps.startPosition=s,t.appProps.text=m),B(c),t.frameContext.drawImage(t.imageBitmap,0,0);const{validBlocks:f,blockHeight:p,blockWidth:u}=v(t.frameContext.getImageData(0,0,t.mainCanvas.width,t.mainCanvas.height),t.appProps.particleRadius);t.validBlocks=f,t.blockHeight=p,t.blockWidth=u,T=E({dimensions:r}),t.workerParticles=I({validBlocks:t.validBlocks,radius:t.appProps.particleRadius,blockHeight:t.blockHeight,blockWidth:t.blockWidth,startPosition:t.appProps.startPosition})},g=(e,n)=>{let c=!0;t.frameContext.clearRect(0,0,t.frameCanvas.width,t.frameCanvas.height),t.workerParticles.forEach(a=>{C(a,e,n,{width:t.mainCanvas.width,height:t.mainCanvas.height}),t.frameContext.drawImage(t.imageBitmap,a.targetX,a.targetY,t.appProps.particleRadius,t.appProps.particleRadius,Math.floor(a.x),Math.floor(a.y),t.appProps.particleRadius,t.appProps.particleRadius),(a.x!==a.targetX||a.y!==a.targetY)&&(c=!1)});const r=t.frameCanvas.transferToImageBitmap();t.mainContext.transferFromImageBitmap(r),c?t.animationFrameId&&cancelAnimationFrame(t.animationFrameId):t.animationFrameId=requestAnimationFrame(a=>g(e,a))},S=()=>{C=new Function(t.appProps.movementFunctionCode)();const e=performance.now();g(e,e)};self.onmessage=e=>{const n={[l.INITIALIZE]:a=>{F(a),self.postMessage({type:h.INITIALIZED,data:t.appProps})},[l.PLAY]:()=>{S()},[l.RESET]:()=>{t.workerParticles=t.workerParticles.map(o=>{const i=T[t.appProps.startPosition]();return{x:i.x,y:i.y,initialX:i.x,initialY:i.y,targetX:o.targetX,targetY:o.targetY}}),t.frameContext.clearRect(0,0,t.frameCanvas.width,t.frameCanvas.height);const a=t.frameCanvas.transferToImageBitmap();t.mainContext.transferFromImageBitmap(a),t.animationFrameId&&cancelAnimationFrame(t.animationFrameId)},[l.RESIZE_PARTICLE_RADIUS]:a=>{t.appProps.particleRadius=a.particleRadius,t.frameContext.drawImage(t.imageBitmap,0,0);const{validBlocks:o,blockHeight:i,blockWidth:s}=v(t.frameContext.getImageData(0,0,t.mainCanvas.width,t.mainCanvas.height),t.appProps.particleRadius);if(t.validBlocks=o,t.blockHeight=i,t.blockWidth=s,t.workerParticles=I({validBlocks:t.validBlocks,radius:t.appProps.particleRadius,blockHeight:t.blockHeight,blockWidth:t.blockWidth,startPosition:t.appProps.startPosition}),self.postMessage({type:h.UPDATE_APP_PROPS,data:t.appProps}),t.animationFrameId){cancelAnimationFrame(t.animationFrameId);const m=performance.now();g(m,m)}},[l.UPDATE_START_POSITION]:a=>{if(t.appProps.startPosition=a.startPosition,t.workerParticles.length){if(t.workerParticles.forEach(o=>{const i=T[t.appProps.startPosition]();o.initialX=i.x,o.initialY=i.y,o.x=i.x,o.y=i.y}),self.postMessage({type:h.UPDATE_APP_PROPS,data:t.appProps}),t.animationFrameId){cancelAnimationFrame(t.animationFrameId);const o=performance.now();g(o,o)}}else console.error("updateStartPosition failed, particles were not initialized",{workerParticles:t.workerParticles})},[l.UPDATE_SELECTED_MOVEMENT_FUNCTION]:a=>{const{key:o,movementFunctionCode:i}=a??{};o&&(t.appProps.selectedMovementFunction=o),(i!==void 0||i!==null)&&(t.appProps.movementFunctionCode=i),self.postMessage({type:h.UPDATE_APP_PROPS,data:t.appProps})},[l.UPDATE_TEXT]:a=>{t.appProps.text=a.text,self.postMessage({type:h.UPDATE_APP_PROPS,data:t.appProps})},[l.UPDATE_BITMAP]:a=>{if(t.imageBitmap=a,t.frameCanvas&&t.mainCanvas){t.frameCanvas.width=t.imageBitmap.width,t.frameCanvas.height=t.imageBitmap.height,t.mainCanvas.width=t.imageBitmap.width,t.mainCanvas.height=t.imageBitmap.height,t.frameContext.drawImage(t.imageBitmap,0,0);const{validBlocks:o,blockHeight:i,blockWidth:s}=v(t.frameContext.getImageData(0,0,t.mainCanvas.width,t.mainCanvas.height),t.appProps.particleRadius);t.validBlocks=o,t.blockHeight=i,t.blockWidth=s,T=E({dimensions:{width:t.mainCanvas.width,height:t.mainCanvas.height}}),t.workerParticles=I({validBlocks:t.validBlocks,radius:t.appProps.particleRadius,blockHeight:t.blockHeight,blockWidth:t.blockWidth,startPosition:t.appProps.startPosition})}}},{data:c,type:r}=e.data;n[r](c)};const I=({validBlocks:e,radius:n,blockHeight:c,blockWidth:r,startPosition:a})=>{const o=[];for(let i=0;i<c;i++)for(let s=0;s<r;s++){const m=i*r+s;if(e[m]){const f=s*n,p=i*n,{x:u,y:d}=T[a]();o.push({targetX:f,targetY:p,x:u,y:d,initialX:u,initialY:d})}}return console.log("Particles amount: ",o.length),o}})();
