(function(){"use strict";const R="random",M="DEV_EXAMPLE",B="WIX 🤠",U="#ffffff",F=["#ff0000","#00ff00","#0000ff"],S={fontFamily:"Arial",fontSize:90,italic:!0,weight:400,letterSpacing:0},L=`// This function will be called twice for each particle, because all particles reach the target in two frames.
...
return (particle, animationStartTime, currentTime, canvasDimensions, animationDuration) => {
  ...
  t < 0.5
    ...
    */`},{name:"elasticIn",definition:` const elasticIn = (x) => {
    ...
    }`,comment:""}],Y=`return (particle, animationStartTime, currentTime) => {
...
};`,q=`return (particle, animationStartTime, currentTime, canvasDimensions) => {
...
}`,H=()=>Object.assign({},{[M]:{code:`${g}${N}`},DEV_TWO_FRAMES:{code:`${g}${L}`},bezier:{code:`${g}${Y}`},pulseColorCycle:{code:`${g}${q}`}},...X.map(({name:a,comment:n,definition:s})=>({[a]:{code:`${g}return (particle, animationStartTime, currentTime, canvasDimensions, animationDuration) => {
...
};`}}))),A=(a,n)=>{const{width:r,height:i,data:t}=a,o=Math.ceil(r/n),c=Math.ceil(i/n),d=new Uint8Array(Math.ceil(r/n)*Math.ceil(i/n));let f=0;for(let p=0;p<i;p+=n)for(let h=0;h<r;h+=n){let u=!1;for(let P=0;P<n&&!u;P++)for(let T=0;T<n&&!u;T++){const x=h+T,b=p+P;if(x<r&&b<i){const w=(b*r+x)*4;t[w+3]>10&&(u=!0)}}d[f++]=u?1:0}return{validBlocks:d,blockWidth:o,blockHeight:c}},C=(a,n,s)=>a+s*(n-a),y=a=>{a=a.replace(/^#/,"");const n=parseInt(a,16),s=n>>16&255,r=n>>8&255,i=n&255;return{r:s,g:r,b:i}},W=(a,n,s)=>"#"+((1<<24)+(a<<16)+(n<<8)+s).toString(16).slice(1),O=(a,n)=>{if(!(a!=null&&a.length))return"#ffffff";if(a.length===1)return a[0];const r=Math.max(0,Math.min(1,n))*(a.length-1),i=Math.floor(r);if(i===a.length-1)return a[a.length-1];const t=r-i,o=y(a[i]),c=y(a[i+1]),d=Math.round(C(o.r,c.r,t)),f=Math.round(C(o.g,c.g,t)),p=Math.round(C(o.b,c.b,t));return W(d,f,p)},D=({dimensions:{width:a,height:n}})=>({top:()=>({x:Math.random()*a,y:0}),center:()=>({x:Math.round(a/2),y:Math.round(n/2)}),bottom:()=>({x:Math.random()*a,y:n}),random:()=>({x:Math.random()*a,y:Math.random()*n}),left:()=>({x:0,y:Math.random()*n}),right:()=>({x:a,y:Math.random()*n}),"top-left":()=>({x:Math.random()*(a/5),y:Math.random()*(n/5)}),"top-right":()=>({x:a,y:Math.random()*(n/5)}),"bottom-left":()=>({x:Math.random()*(a/5),y:n-Math.random()*(n/5)}),"bottom-right":()=>({x:a-Math.random()*(a/5),y:n-Math.random()*(n/5)})});let k;const e={workerParticles:[],bubbleParticles:[],imageBitmap:null,animationFrameId:0,frameCanvas:null,frameContext:null,mainCanvas:null,mainContext:null,validBlocks:null,blockHeight:0,blockWidth:0,appProps:{particleRadius:5,startPosition:R,selectedMovementFunction:M,movementFunctionCode:H()[M].code,text:B,font:S,particleColors:F,animationDuration:2e3,enableBubbles:!1},revealProgress:0};let v;const $=async a=>{e.mainCanvas=a,e.mainContext=e.mainCanvas.getContext("bitmaprenderer"),e.frameCanvas=new OffscreenCanvas(e.mainCanvas.width,e.mainCanvas.height),e.frameContext=e.frameCanvas.getContext("2d",{willReadFrequently:!0})},j=a=>{const{imageBitmap:n,canvas:s,dimensions:r,appProps:i}=a;e.imageBitmap=n,Object.keys(i).length&&(e.appProps={...i,animationDuration:i.animationDuration??2e3}),$(s),e.frameContext.drawImage(e.imageBitmap,0,0);const{validBlocks:t,blockHeight:o,blockWidth:c}=A(e.frameContext.getImageData(0,0,e.mainCanvas.width,e.mainCanvas.height),e.appProps.particleRadius);e.validBlocks=t,e.blockHeight=o,e.blockWidth=c,v=D({dimensions:r}),e.workerParticles=_({validBlocks:e.validBlocks,radius:e.appProps.particleRadius,blockHeight:e.blockHeight,blockWidth:e.blockWidth,startPosition:e.appProps.startPosition})},Q=(a,n,s,r=5)=>{const i=[];for(let t=0;t<r;t++){const o=Math.random()*Math.PI*2,c=.5+Math.random()*2;i.push({x:a,y:n,dx:Math.cos(o)*c,dy:Math.sin(o)*c-1,radius:2+Math.random()*5,color:s,opacity:.7+Math.random()*.3,life:0,maxLife:50+Math.random()*100})}return i},_=({validBlocks:a,radius:n,blockHeight:s,blockWidth:r,startPosition:i})=>{const t=[];for(let o=0;o<s;o++)for(let c=0;c<r;c++){const d=o*r+c;if(a[d]){const f=c*n,p=o*n,{x:h,y:u}=v[i]();t.push({targetX:f,targetY:p,x:h,y:u,initialX:h,initialY:u,scale:1,opacity:1,color:U,revealProgress:0,revealThreshold:.7+Math.random()*.25,reachedTarget:!1,emittedBubbles:!1})}}return t},I=(a,n)=>{let s=!0;e.frameContext.clearRect(0,0,e.frameCanvas.width,e.frameCanvas.height);const r=n-a;e.revealProgress=Math.min(1,r/e.appProps.animationDuration);for(let t=e.bubbleParticles.length-1;t>=0;t--){const o=e.bubbleParticles[t];o.x+=o.dx,o.y+=o.dy,o.dx+=(Math.random()-.5)*.1,o.dy-=.02,o.life++;const c=o.life/o.maxLife,d=o.opacity*(1-c);e.frameContext.beginPath(),e.frameContext.arc(Math.floor(o.x),Math.floor(o.y),o.radius,0,Math.PI*2),e.frameContext.fillStyle=O(e.appProps.particleColors,c),e.frameContext.globalAlpha=d,e.frameContext.fill(),o.life>=o.maxLife&&e.bubbleParticles.splice(t,1)}e.frameContext.globalAlpha=1,e.workerParticles.forEach((t,o)=>{var f;if(o/e.workerParticles.length<=e.revealProgress){k(t,a,n,{width:e.mainCanvas.width,height:e.mainCanvas.height},e.appProps.animationDuration);const p=t.targetX-t.initialX,h=t.targetY-t.initialY,u=Math.sqrt(p*p+h*h),P=t.targetX-t.x,T=t.targetY-t.y,x=Math.sqrt(P*P+T*T),b=u>0?1-x/u:1;if(t.revealThreshold===void 0&&(t.revealThreshold=.7+Math.random()*.25),t.revealProgress=b>=t.revealThreshold?Math.min(1,(b-t.revealThreshold)/(1-t.revealThreshold)*3):0,((f=e.appProps.particleColors)==null?void 0:f.length)>0&&(e.appProps.particleColors.length===1?t.color=e.appProps.particleColors[0]:t.color=O(e.appProps.particleColors,b)),Math.abs(t.x-t.targetX)<.5&&Math.abs(t.y-t.targetY)<.5&&!t.emittedBubbles&&e.appProps.enableBubbles){t.emittedBubbles=!0;const E=Q(t.x,t.y,t.color,2+Math.floor(Math.random()*3));e.bubbleParticles.push(...E)}if(t.revealProgress>=1)e.frameContext.drawImage(e.imageBitmap,t.targetX,t.targetY,e.appProps.particleRadius,e.appProps.particleRadius,Math.floor(t.x),Math.floor(t.y),e.appProps.particleRadius,e.appProps.particleRadius);else{const E=Math.floor(e.appProps.particleRadius*(t.scale||1));t.revealProgress>0&&(e.frameContext.globalAlpha=t.revealProgress*(t.opacity||1),e.frameContext.drawImage(e.imageBitmap,t.targetX,t.targetY,e.appProps.particleRadius,e.appProps.particleRadius,Math.floor(t.x),Math.floor(t.y),e.appProps.particleRadius,e.appProps.particleRadius),e.frameContext.globalAlpha=1),e.frameContext.beginPath(),e.frameContext.arc(Math.floor(t.x)+E/2,Math.floor(t.y)+E/2,E/2,0,Math.PI*2),e.frameContext.fillStyle=t.color,t.opacity!==void 0?e.frameContext.globalAlpha=(1-t.revealProgress)*t.opacity:e.frameContext.globalAlpha=1-t.revealProgress,e.frameContext.fill(),e.frameContext.globalAlpha=1}(t.x!==t.targetX||t.y!==t.targetY)&&(s=!1)}else s=!1});const i=e.frameCanvas.transferToImageBitmap();e.mainContext.transferFromImageBitmap(i),!s||e.bubbleParticles.length>0?e.animationFrameId=requestAnimationFrame(t=>I(a,t)):e.animationFrameId&&(cancelAnimationFrame(e.animationFrameId),e.frameContext.drawImage(e.imageBitmap,0,0),e.bubbleParticles=[])},V=()=>{k=new Function(e.appProps.movementFunctionCode)();const a=performance.now();e.revealProgress=0,e.bubbleParticles=[],e.workerParticles.forEach(n=>{n.emittedBubbles=!1}),I(a,a)};self.onmessage=a=>{const{payload:n,type:s}=a.data;switch(s){case l.INITIALIZE:{j(n),self.postMessage({type:m.INITIALIZED,data:e.appProps});break}case l.PLAY:{e.animationFrameId&&cancelAnimationFrame(e.animationFrameId),e.bubbleParticles=[],V();break}case l.RESET:{e.animationFrameId&&cancelAnimationFrame(e.animationFrameId),e.workerParticles=e.workerParticles.map(i=>{const t=v[e.appProps.startPosition]();return{x:t.x,y:t.y,initialX:t.x,initialY:t.y,targetX:i.targetX,targetY:i.targetY,scale:1,opacity:1,color:i.color,revealProgress:0,revealThreshold:i.revealThreshold}}),e.frameContext.clearRect(0,0,e.frameCanvas.width,e.frameCanvas.height);const r=e.frameCanvas.transferToImageBitmap();e.mainContext.transferFromImageBitmap(r),e.animationFrameId&&cancelAnimationFrame(e.animationFrameId);break}case l.RESIZE_PARTICLE_RADIUS:{e.appProps.particleRadius=n,e.frameContext.drawImage(e.imageBitmap,0,0);const{validBlocks:r,blockHeight:i,blockWidth:t}=A(e.frameContext.getImageData(0,0,e.mainCanvas.width,e.mainCanvas.height),e.appProps.particleRadius);if(e.validBlocks=r,e.blockHeight=i,e.blockWidth=t,e.workerParticles=_({validBlocks:e.validBlocks,radius:e.appProps.particleRadius,blockHeight:e.blockHeight,blockWidth:e.blockWidth,startPosition:e.appProps.startPosition}),self.postMessage({type:m.UPDATE_APP_PROPS,data:e.appProps}),e.animationFrameId){cancelAnimationFrame(e.animationFrameId);const o=performance.now();I(o,o)}break}case l.UPDATE_START_POSITION:{if(e.appProps.startPosition=n,e.workerParticles.length){if(e.workerParticles.forEach(r=>{const i=v[e.appProps.startPosition]();r.initialX=i.x,r.initialY=i.y,r.x=i.x,r.y=i.y}),self.postMessage({type:m.UPDATE_APP_PROPS,data:e.appProps}),e.animationFrameId){cancelAnimationFrame(e.animationFrameId);const r=performance.now();I(r,r)}}else console.error("updateStartPosition failed, particles were not initialized",{workerParticles:e.workerParticles});break}case l.UPDATE_SELECTED_MOVEMENT_FUNCTION:{const{key:r,movementFunctionCode:i}=n??{};r&&(e.appProps.selectedMovementFunction=r),i!=null&&(e.appProps.movementFunctionCode=i),self.postMessage({type:m.UPDATE_APP_PROPS,data:e.appProps});break}case l.UPDATE_TEXT:{e.appProps.text=n,self.postMessage({type:m.UPDATE_APP_PROPS,data:e.appProps});break}case l.UPDATE_FONT:{e.appProps.font=n,self.postMessage({type:m.UPDATE_APP_PROPS,data:e.appProps});break}case l.UPDATE_PARTICLE_COLORS:{if(e.appProps.particleColors=n,n.length>0,self.postMessage({type:m.UPDATE_APP_PROPS,data:e.appProps}),e.animationFrameId){cancelAnimationFrame(e.animationFrameId);const r=performance.now();I(r,r)}break}case l.UPDATE_BITMAP:{if(e.imageBitmap=n,e.frameCanvas&&e.mainCanvas){e.frameCanvas.width=e.imageBitmap.width,e.frameCanvas.height=e.imageBitmap.height,e.mainCanvas.width=e.imageBitmap.width,e.mainCanvas.height=e.imageBitmap.height,e.frameContext.drawImage(e.imageBitmap,0,0);const{validBlocks:r,blockHeight:i,blockWidth:t}=A(e.frameContext.getImageData(0,0,e.mainCanvas.width,e.mainCanvas.height),e.appProps.particleRadius);e.validBlocks=r,e.blockHeight=i,e.blockWidth=t,v=D({dimensions:{width:e.mainCanvas.width,height:e.mainCanvas.height}}),e.workerParticles=_({validBlocks:e.validBlocks,radius:e.appProps.particleRadius,blockHeight:e.blockHeight,blockWidth:e.blockWidth,startPosition:e.appProps.startPosition})}break}case l.UPDATE_ANIMATION_DURATION:{e.appProps.animationDuration=n,self.postMessage({type:m.UPDATE_APP_PROPS,data:e.appProps}),e.animationFrameId&&(e.bubbleParticles=[]);break}case l.UPDATE_ENABLE_BUBBLES:{e.appProps.enableBubbles=n,self.postMessage({type:m.UPDATE_APP_PROPS,data:e.appProps});break}}}})();
