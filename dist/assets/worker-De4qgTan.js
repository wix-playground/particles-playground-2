(function(){"use strict";const w="random",P="DEV_EXAMPLE",y="WIX 🤠",O={fontFamily:"Arial",fontSize:90,italic:!0,weight:400,letterSpacing:0},_=`// This function will be called twice for each particle, because all particles reach the target in two frames.
...
return (particle, animationStartTime, currentTime, canvasDimensions) => {
...
}`;var m=(a=>(a.INITIALIZE="INITIALIZE",a.PLAY="PLAY",a.RESET="RESET",a.RESIZE_PARTICLE_RADIUS="RESIZE_PARTICLE_RADIUS",a.UPDATE_START_POSITION="UPDATE_START_POSITION",a.UPDATE_SELECTED_MOVEMENT_FUNCTION="UPDATE_SELECTED_MOVEMENT_FUNCTION",a.UPDATE_BITMAP="UPDATE_BITMAP",a.UPDATE_TEXT="UPDATE_TEXT",a.UPDATE_FONT="UPDATE_FONT",a))(m||{}),p=(a=>(a.INITIALIZED="INITIALIZED",a.UPDATE_APP_PROPS="UPDATE_APP_PROPS",a))(p||{});const D=[{name:"linear",definition:"const linear = (t) => t;",comment:`/**
  ...
  t < 0.5
    ...
    */`},{name:"elasticIn",definition:` const elasticIn = (x) => {
    ...
    }`,comment:""}],R=`return (particle, animationStartTime, currentTime) => {
...
};`,F=()=>Object.assign({},{[P]:{code:A},DEV_TWO_FRAMES:{code:_},bezier:{code:R}},...D.map(({name:a,comment:n,definition:s})=>({[a]:{code:`return (particle, animationStartTime, currentTime, canvasDimensions) => {
